...
type
  TTestHashMap = specialize TRtmHashMapImpl<UInt64, UInt64>;
...
procedure TestRtmHashMapBasic;
var
  LMap: TTestHashMap;
  LValue: UInt64;
begin
  WriteLn('TestRtmHashMapBasic:');
...
procedure TestRtmHashMapInsert;
var
  LMap: TTestHashMap;
  LValue: UInt64;
begin
  WriteLn('TestRtmHashMapInsert:');
  LMap := TTestHashMap.Create(4);
  try
    // TryInsert
...
procedure TestRtmHashMapGetOrInsert;
var
  LMap: TTestHashMap;
  LResult: TTestHashMap.TGetOrInsertResult;
begin
  WriteLn('TestRtmHashMapGetOrInsert:');
  LMap := TTestHashMap.Create(4);
  try
    // GetOrInsert
...
procedure TestRtmHashMapGetOrUpdate;
var
  LMap: TTestHashMap;
  LResult: TTestHashMap.TGetOrInsertResult;
begin
  WriteLn('TestRtmHashMapGetOrUpdate:');
  LMap := TTestHashMap.Create(4);
  try
...
procedure TestRtmHashMapReserve;
var
  LMap: TTestHashMap;
begin
  WriteLn('TestRtmHashMapReserve:');
  LMap := TTestHashMap.Create(4);
  try
...
procedure TestRtmHashMapRtmSupport;
var
  LMap: TTestHashMap;
begin
  WriteLn('TestRtmHashMapRtmSupport:');
  LMap := TTestHashMap.Create(4);
  try
    // Check RTM support
    WriteLn('  RTM Supported: ', LMap.IsRtmSupported);
    Check(True, 'IsRtmSupported called');
  finally
    LMap.Free;
  end;
end;

procedure TestRtmHashMapClear;
var
  LMap: TTestHashMap;
begin
  WriteLn('TestRtmHashMapClear:');
  LMap := TTestHashMap.Create(4);
  try
    LMap.Insert(1, 100);
    LMap.Insert(2, 200);
...
begin
  WriteLn('=== RTM HashMap Tests ===');
  WriteLn;

  TestRtmHashMapBasic;
  TestRtmHashMapInsert;
  TestRtmHashMapGetOrInsert;
  TestRtmHashMapGetOrUpdate;
  TestRtmHashMapReserve;
  TestRtmHashMapRtmSupport;
  TestRtmHashMapClear;
