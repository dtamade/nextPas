...
- **v6.7**: Usability — F-04 注释修正, F-02 CheckNearRel/ToBeNearRel 相对容差, F-03 ExpectStr 别名, F-12 /dev/urandom shuffle 种子, F-13 GetTopSlowest 优化, F-05 Mock VerifyAll + 错误消息改进, F-06 CheckSnapshot 快照测试
