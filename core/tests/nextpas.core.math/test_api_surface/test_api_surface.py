...
FACADE_TYPE_ALIAS_COMPILE_TEST_MARKER = "T.Test('facade type alias compile surface'"
FACADE_ROOT_IMPORT_TEST_MARKER = "T.Test('facade imports only root math unit'"
...
REQUIRED_FACADE_TYPE_ALIAS_COMPILE_USES = {
    ...
    "tfpuexception": "LFPUExc: TFPUException",
    "tfpuexceptionmask": "LFPUMask: TFPUExceptionMask",
}
ROOT_FACADE_DIRECT_IMPLEMENTATIONS = {
    "getexceptionmask",
    "setexceptionmask",
}
ROOT_FACADE_DIRECT_TYPE_DEFINITIONS = {
    "tfpuexception",
    "tfpuexceptionmask",
}
...
REQUIRED_BEHAVIOR_TEST_MARKERS: tuple[RequiredBehaviorTestMarker, ...] = (
    ...
    RequiredBehaviorTestMarker("facade-random", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Test('facade random surface'"),
    RequiredBehaviorTestMarker("facade-root-forwarders", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Test('facade root forwarder compile surface'"),
    ...
    RequiredBehaviorTestMarker("facade-root-trig-declaration-parity", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Test('facade root trig declaration parity compile surface'"),
    RequiredBehaviorTestMarker("facade-public-member-compile-surface", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Test('facade public member compile surface'"),
    RequiredBehaviorTestMarker("facade-public-member-vector", "tests/nextpas.core.math/test_facade/test_facade.lpr", "facade public member compile surface touches vector members"),
    RequiredBehaviorTestMarker("facade-public-member-matrix", "tests/nextpas.core.math/test_facade/test_facade.lpr", "facade public member compile surface touches matrix members"),
    RequiredBehaviorTestMarker("facade-public-member-quaternion", "tests/nextpas.core.math/test_facade/test_facade.lpr", "facade public member compile surface touches quaternion members"),
    RequiredBehaviorTestMarker("facade-public-member-random-noise", "tests/nextpas.core.math/test_facade/test_facade.lpr", "facade public member compile surface touches random and noise members"),
    RequiredBehaviorTestMarker("facade-trig-power-finite-identity-precision", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Test('facade Power finite identity precision contracts'"),
    RequiredBehaviorTestMarker("facade-log-exact-identity", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Test('facade Log exact identity contracts'"),
    RequiredBehaviorTestMarker("facade-trig-ieee-domain-smoke", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Test('facade trig IEEE domain smoke'"),
    RequiredBehaviorTestMarker("symbol-scope-expanded-common-symbols", "tests/nextpas.core.math/test_symbol_scope/test_symbol_scope.lpr", "T.Test('expanded scalar/trig common symbols'"),
    RequiredBehaviorTestMarker("symbol-scope-root-abs-round-ln", "tests/nextpas.core.math/test_symbol_scope/test_symbol_scope.lpr", "Root Abs/Round/Ln/Log/Sqrt resolve to nextpas.core.math"),
    ...
    RequiredBehaviorTestMarker("trig-direct-non-finite-overload-parity", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('direct trig non-finite overload parity contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-precision-domain-hardening", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('trig precision domain hardening contracts'"),
    ...
    RequiredBehaviorTestMarker("scalar-ieee-edge-contracts", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('scalar IEEE edge contracts'"),
    ...
    RequiredBehaviorTestMarker("vector-min-subnormal-length-normalize", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector min subnormal length and normalize contracts'"),
    ...
    RequiredBehaviorTestMarker("scalar-predicate-direct-matrix", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('scalar predicate direct matrix contracts'"),
    RequiredBehaviorTestMarker("scalar-predicate-single-positive-infinity", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "IsInfinite Single positive infinity"),
    RequiredBehaviorTestMarker("scalar-predicate-single-negative-infinity", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "IsInfinite Single negative infinity"),
    RequiredBehaviorTestMarker("scalar-predicate-double-negative-infinity", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "IsInfinite Double negative infinity"),
    RequiredBehaviorTestMarker("scalar-predicate-finite-false", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "IsNaN and IsInfinite reject finite values"),
    RequiredBehaviorTestMarker("scalar-predicate-nan-vs-infinity-false", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "IsInfinite rejects NaN and IsNaN rejects infinity"),
    RequiredBehaviorTestMarker("scalar-clamp-finite-bound-matrix", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('scalar Clamp finite-bound matrix contracts'"),
    RequiredBehaviorTestMarker("scalar-clamp-double-infinite-min", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Clamp Double infinite minimum"),
    RequiredBehaviorTestMarker("scalar-clamp-double-infinite-max", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Clamp Double infinite maximum"),
    RequiredBehaviorTestMarker("scalar-clamp-single-infinite-min", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Clamp Single infinite minimum"),
    RequiredBehaviorTestMarker("scalar-clamp-single-nan-max", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Clamp Single NaN maximum"),
    RequiredBehaviorTestMarker("scalar-interpolation", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('interpolation'"),
    ...
    RequiredBehaviorTestMarker("scalar-lerp-endpoint-identity-double", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Lerp Double endpoint t=0 preserves non-finite A"),
    RequiredBehaviorTestMarker("scalar-lerp-endpoint-identity-single", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Lerp Single endpoint t=1 preserves B"),
    RequiredBehaviorTestMarker("scalar-lerp-nan-t-propagates", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Lerp Double NaN t propagates NaN"),
    ...
    RequiredBehaviorTestMarker("scalar-inverse-lerp-non-finite", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "InverseLerp Double positive infinity value returns positive infinity"),
    ...
    RequiredBehaviorTestMarker("scalar-smoothstep-infinite-value", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "SmoothStep Double positive infinity value clamps high"),
    RequiredBehaviorTestMarker("scalar-smoothstep-single-infinite-value", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "SmoothStep Single negative infinity value clamps low"),
    ...
    RequiredBehaviorTestMarker("scalar-wrap-signed-zero", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Wrap Double in-range negative zero preserves sign"),
    RequiredBehaviorTestMarker("scalar-wrap-single-signed-zero", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "Wrap Single in-range negative zero preserves sign"),
    RequiredBehaviorTestMarker("scalar-range-boundary-edges", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('scalar range boundary edge contracts'"),
    ...
    RequiredBehaviorTestMarker("scalar-rounding-sign", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('rounding and sign'"),
    RequiredBehaviorTestMarker("scalar-sign-angle-edge-contracts", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('scalar sign and angle edge contracts'"),
    ...
    RequiredBehaviorTestMarker("scalar-float-predicates", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('float predicates'"),
    RequiredBehaviorTestMarker("scalar-extras", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('number theory and scalar extras'"),
    RequiredBehaviorTestMarker("scalar-gcd-lcm-int64-boundary", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('GCD LCM Int64 boundary contracts'"),
    ...
    RequiredBehaviorTestMarker("scalar-angle-conversions", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('angle conversions'"),
    RequiredBehaviorTestMarker("scalar-boundaries", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('integer rounding boundaries'"),
    RequiredBehaviorTestMarker("scalar-rounding-subnormal-contracts", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('scalar rounding subnormal contracts'"),
    ...
    RequiredBehaviorTestMarker("scalar-owner-messages", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('owner-level boundary messages'"),
    RequiredBehaviorTestMarker("scalar-single-boundary-messages", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('single-precision boundary messages'"),
    RequiredBehaviorTestMarker("scalar-overflow", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Test('overflow helpers'"),
    RequiredBehaviorTestMarker("trig-basic", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('basic trig values'"),
    RequiredBehaviorTestMarker("trig-inverse-domain", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('inverse trig domain contracts'"),
    RequiredBehaviorTestMarker("trig-inverse-non-finite", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('inverse trig non-finite contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-circular-non-finite", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('circular trig non-finite contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-circular-signed-zero", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('circular trig signed zero contracts'"),
    RequiredBehaviorTestMarker("trig-circular-finite-precision", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('circular trig finite precision contracts'"),
    RequiredBehaviorTestMarker("trig-atan-special", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('ArcTan special contracts'"),
    RequiredBehaviorTestMarker("trig-atan2-special", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('ArcTan2 special cases'"),
    RequiredBehaviorTestMarker("trig-atan2-one-infinite", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('ArcTan2 one-infinite contracts'"),
    RequiredBehaviorTestMarker("trig-atan2-signed-zero", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('ArcTan2 signed zero contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-atan2-finite-extreme-ratio", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('ArcTan2 finite extreme ratio contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-exp-log-sqrt", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('exp/log/sqrt contracts'"),
    RequiredBehaviorTestMarker("trig-exp-log-sqrt-finite-precision", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('exp log sqrt finite precision contracts'"),
    RequiredBehaviorTestMarker("trig-exp-sqrt-ieee", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('exp sqrt IEEE contracts'"),
    RequiredBehaviorTestMarker("trig-exp-negative-infinity", "tests/nextpas.core.math/test_trig/test_trig.lpr", "Exp(-Inf)=+0"),
    RequiredBehaviorTestMarker("trig-exp-finite-overflow-underflow", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('Exp finite overflow underflow contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-sqrt-finite-extremes-subnormal", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('Sqrt finite extremes subnormal contracts'"),
    RequiredBehaviorTestMarker("trig-sqrt-negative-zero", "tests/nextpas.core.math/test_trig/test_trig.lpr", "Sqrt(-0)=-0"),
    RequiredBehaviorTestMarker("trig-log-domain-signed-zero", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('log domain signed zero contracts'"),
    RequiredBehaviorTestMarker("trig-log-base-identities", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('log base identity contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-log-positive-subnormal", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('log positive subnormal contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-power", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('power edge contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-power-negative-non-integer", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('power negative finite base non-integer contracts'"),
    RequiredBehaviorTestMarker("trig-power-non-finite", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('power non-finite contracts'"),
    ...
    RequiredBehaviorTestMarker("trig-power-finite-identity-precision", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('Power finite identity precision contracts'"),
    RequiredBehaviorTestMarker("trig-power-finite-overflow-underflow-sign", "tests/nextpas.core.math/test_trig/test_trig.lpr", "T.Test('Power finite overflow underflow sign contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-2f", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec2f contracts'"),
    RequiredBehaviorTestMarker("vec-2f-huge-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec2f huge finite length + normalize'"),
    RequiredBehaviorTestMarker("vec-3f", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec3f contracts'"),
    RequiredBehaviorTestMarker("vec-3f-huge-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec3f huge finite length + normalize'"),
    RequiredBehaviorTestMarker("vec-4f", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec4f contracts'"),
    RequiredBehaviorTestMarker("vec-4f-huge-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec4f huge finite length + normalize'"),
    RequiredBehaviorTestMarker("vec-double", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('double precision vector contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-2d-huge-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec2d huge finite length + normalize'"),
    RequiredBehaviorTestMarker("vec-3d-huge-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec3d huge finite length + normalize'"),
    RequiredBehaviorTestMarker("vec-4d-huge-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('TVec4d huge finite length + normalize'"),
    RequiredBehaviorTestMarker("vec-lengthsqr-huge-finite-overflow", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector huge finite LengthSqr overflow contract'"),
    ...
    RequiredBehaviorTestMarker("vec-dot-huge-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector huge finite Dot contract'"),
    RequiredBehaviorTestMarker("vec-cross-huge-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector huge finite Cross cancellation contract'"),
    ...
    RequiredBehaviorTestMarker("vec-cross-out-of-range-signed-inf", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector huge finite Cross out-of-range signed infinity contract'"),
    ...
    RequiredBehaviorTestMarker("vec-data-write-through", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector Data aliases write through'"),
    RequiredBehaviorTestMarker("vec-measure-non-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector measure non-finite contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-measure-single-lengthsqr-inf", "tests/nextpas.core.math/test_vec/test_vec.lpr", "TVec4f LengthSqr infinite component returns +Inf"),
    RequiredBehaviorTestMarker("vec-measure-single-dot-zero-times-inf", "tests/nextpas.core.math/test_vec/test_vec.lpr", "TVec4f Dot zero times infinity returns NaN"),
    RequiredBehaviorTestMarker("vec-measure-single-cross-raw-non-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "TVec3f Cross raw non-finite fallback returns NaN component"),
    RequiredBehaviorTestMarker("vec-measure-non-finite-type-matrix", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector measure non-finite type matrix contracts'"),
    RequiredBehaviorTestMarker("vec-measure-type-matrix-vec2d-length-nan", "tests/nextpas.core.math/test_vec/test_vec.lpr", "TVec2d Length NaN component returns NaN"),
    RequiredBehaviorTestMarker("vec-measure-type-matrix-vec2d-lengthsqr-inf", "tests/nextpas.core.math/test_vec/test_vec.lpr", "TVec2d LengthSqr infinite component returns +Inf"),
    RequiredBehaviorTestMarker("vec-measure-type-matrix-vec3f-dot-inf", "tests/nextpas.core.math/test_vec/test_vec.lpr", "TVec3f Dot infinite component returns +Inf"),
    RequiredBehaviorTestMarker("vec-measure-type-matrix-vec2d-dot-zero-inf", "tests/nextpas.core.math/test_vec/test_vec.lpr", "TVec2d Dot zero times infinity returns NaN"),
    RequiredBehaviorTestMarker("vec-measure-type-matrix-vec4d-dot-zero-inf", "tests/nextpas.core.math/test_vec/test_vec.lpr", "TVec4d Dot zero times infinity returns NaN"),
    RequiredBehaviorTestMarker("vec-measure-non-finite-coverage-matrix", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector measure non-finite coverage matrix contracts'"),
    RequiredBehaviorTestMarker("vec-raw-arithmetic-special-values", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector raw arithmetic special-value contracts'"),
    RequiredBehaviorTestMarker("vec-signed-zero", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector signed-zero contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-signed-zero-coverage-matrix", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector signed-zero coverage matrix contracts'"),
    RequiredBehaviorTestMarker("vec-data-signed-zero-bits", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector Data aliases preserve signed-zero bits'"),
    RequiredBehaviorTestMarker("vec-lerp-scalar-parity", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector Lerp scalar parity contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-normalize-max-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector max finite normalize contract'"),
    RequiredBehaviorTestMarker("vec-normalize-raw-non-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('raw vector normalize non-finite inputs fail fast'"),
    RequiredBehaviorTestMarker("vec-division-invalid-divisors", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector division invalid divisors fail fast'"),
    RequiredBehaviorTestMarker("vec-mixed-invalid-divisor-priority", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector mixed invalid divisor priority contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-equals-non-finite", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Test('vector Equals non-finite comparison contracts'"),
    RequiredBehaviorTestMarker("facade-vector-lerp-scalar-parity", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Test('facade vector Lerp scalar parity contracts'"),
    RequiredBehaviorTestMarker("mat-3f", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('TMat3f contracts'"),
    RequiredBehaviorTestMarker("mat-4f", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('TMat4f contracts'"),
    RequiredBehaviorTestMarker("mat-double", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('double precision matrix contracts'"),
    RequiredBehaviorTestMarker("mat-inverse-fail-close-single", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('single precision inverse fail-close contracts'"),
    RequiredBehaviorTestMarker("mat-inverse-fail-close-double", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('double precision inverse fail-close contracts'"),
    RequiredBehaviorTestMarker("mat-inverse-overwrite-single", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('single precision inverse overwrites out parameter'"),
    RequiredBehaviorTestMarker("mat-inverse-overwrite-double", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('double precision inverse overwrites out parameter'"),
    RequiredBehaviorTestMarker("mat-indexed-alias-write-through", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('matrix indexed aliases write through'"),
    RequiredBehaviorTestMarker("mat-indexed-alias-signed-zero-bits", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('matrix indexed aliases preserve signed-zero bits'"),
    ...
    RequiredBehaviorTestMarker("mat-equals-non-finite", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('matrix Equals non-finite comparison contracts'"),
    RequiredBehaviorTestMarker("mat-arithmetic-special-values", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Test('matrix arithmetic special-value contracts'"),
    RequiredBehaviorTestMarker("mat-arithmetic-transpose-unary-signed-zero", "tests/nextpas.core.math/test_mat/test_mat.lpr", "TMat3f Transpose preserves negative-zero bits"),
    RequiredBehaviorTestMarker("mat-arithmetic-scalar-zero-times-inf", "tests/nextpas.core.math/test_mat/test_mat.lpr", "TMat4d scalar multiply zero times infinity returns NaN"),
    RequiredBehaviorTestMarker("mat-arithmetic-vector-zero-times-inf", "tests/nextpas.core.math/test_mat/test_mat.lpr", "TMat4f vector multiply zero times infinity returns NaN"),
    RequiredBehaviorTestMarker("mat-arithmetic-subnormal-inverse-fail-close", "tests/nextpas.core.math/test_mat/test_mat.lpr", "TMat3d min-subnormal determinant is positive but TryInverse fail-closes"),
    RequiredBehaviorTestMarker("quat-f", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('TQuatf contracts'"),
    RequiredBehaviorTestMarker("quat-d", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('TQuatd contracts'"),
    RequiredBehaviorTestMarker("quat-data-alias-write-through", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('quaternion Data aliases write through'"),
    RequiredBehaviorTestMarker("quat-data-alias-signed-zero-bits", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('quaternion Data aliases preserve signed-zero bits'"),
    ...
    RequiredBehaviorTestMarker("quat-equals-non-finite", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('quaternion Equals non-finite comparison contracts'"),
    RequiredBehaviorTestMarker("quat-axis-finite", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('FromAxisAngle rejects non-finite inputs'"),
    RequiredBehaviorTestMarker("quat-axis-huge-finite", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('FromAxisAngle normalizes huge finite axis'"),
    RequiredBehaviorTestMarker("quat-huge-finite-normalize", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('huge finite normalize'"),
    RequiredBehaviorTestMarker("quat-max-finite-normalize", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('max finite normalize'"),
    RequiredBehaviorTestMarker("quat-interpolation-finite", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Interpolation rejects non-finite t'"),
    RequiredBehaviorTestMarker("quat-raw-non-finite", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('raw quaternion non-finite inputs fail fast'"),
    RequiredBehaviorTestMarker("quat-rotate-vector-non-finite", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Rotate rejects non-finite vector inputs'"),
    RequiredBehaviorTestMarker("quat-interpolation-extrapolation", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Interpolation allows finite extrapolation'"),
    RequiredBehaviorTestMarker("quat-interpolation-endpoints", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Interpolation endpoint contracts'"),
    RequiredBehaviorTestMarker("quat-interpolation-shortest-start", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Interpolation follows shortest path for opposite-sign start'"),
    RequiredBehaviorTestMarker("quat-interpolation-shortest-end", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Interpolation follows shortest path for opposite-sign end'"),
    RequiredBehaviorTestMarker("quat-interpolation-equivalent", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Interpolation stays stable for equivalent endpoints'"),
    RequiredBehaviorTestMarker("quat-interpolation-near-identical", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Interpolation stays stable for near-identical endpoints'"),
    RequiredBehaviorTestMarker("quat-axis-angle-opposite", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('ToAxisAngle canonicalizes opposite-sign rotations'"),
    RequiredBehaviorTestMarker("quat-axis-angle-multiturn", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('ToAxisAngle canonicalizes multi-turn inputs'"),
    RequiredBehaviorTestMarker("quat-axis-angle-half-turns", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('ToAxisAngle canonicalizes FromAxisAngle half-turns'"),
    RequiredBehaviorTestMarker("quat-axis-angle-overwrite-out", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('ToAxisAngle overwrites out parameters'"),
    RequiredBehaviorTestMarker("quat-multiply-order", "tests/nextpas.core.math/test_quat/test_quat.lpr", "T.Test('Quaternion multiplication is non-commutative and right-first'"),
    RequiredBehaviorTestMarker("transform-projection", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('projection builders'"),
    RequiredBehaviorTestMarker("transform-ortho-reversed", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('Ortho allows reversed bounds'"),
    RequiredBehaviorTestMarker("transform-model-view", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('model and view builders'"),
    RequiredBehaviorTestMarker("transform-lookat-up", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('LookAt ignores up magnitude'"),
    RequiredBehaviorTestMarker("transform-lookat-roll", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('LookAt up direction controls roll'"),
    RequiredBehaviorTestMarker("transform-camera-double", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('camera2d and double builders'"),
    RequiredBehaviorTestMarker("transform-camera-zoom", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('Camera2D zoom scales view'"),
    RequiredBehaviorTestMarker("transform-double-parity", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('direct double builder parity'"),
    RequiredBehaviorTestMarker("transform-finite-guards", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('non-finite inputs fail fast'"),
    RequiredBehaviorTestMarker("transform-geometry-guards", "tests/nextpas.core.math/test_transform/test_transform.lpr", "T.Test('geometry guards report public contract messages'"),
    RequiredBehaviorTestMarker("easing-polynomial-expo", "tests/nextpas.core.math/test_easing/test_easing.lpr", "T.Test('polynomial and expo easing'"),
    RequiredBehaviorTestMarker("easing-elastic-back-bounce", "tests/nextpas.core.math/test_easing/test_easing.lpr", "T.Test('elastic back and bounce easing'"),
    RequiredBehaviorTestMarker("easing-out-bounce-piecewise", "tests/nextpas.core.math/test_easing/test_easing.lpr", "T.Test('EaseOutBounce piecewise branches'"),
    RequiredBehaviorTestMarker("easing-out-of-range", "tests/nextpas.core.math/test_easing/test_easing.lpr", "T.Test('finite out-of-range inputs extrapolate'"),
    RequiredBehaviorTestMarker("easing-non-finite", "tests/nextpas.core.math/test_easing/test_easing.lpr", "T.Test('non-finite inputs fail fast'"),
    RequiredBehaviorTestMarker("random-seed", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('seed determinism'"),
    RequiredBehaviorTestMarker("random-zero-seed", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('zero seed uses deterministic default'"),
    RequiredBehaviorTestMarker("random-range", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('range boundaries'"),
    RequiredBehaviorTestMarker("random-state-forced-boundaries", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('state-forced half-open boundaries'"),
    RequiredBehaviorTestMarker("random-unbiased-integer-range", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('integer ranges reject modulo-bias tail states'"),
    RequiredBehaviorTestMarker("random-large-float", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('large finite float range stays finite and half-open'"),
    RequiredBehaviorTestMarker("random-large-finite-forced-max-float-range", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('large finite forced max float range stays finite and half-open'"),
    RequiredBehaviorTestMarker("random-weight-scale", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('WeightedChoice large finite weights stay scale-invariant'"),
    RequiredBehaviorTestMarker("random-weight-zero", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('WeightedChoice rejects all-zero weights'"),
    RequiredBehaviorTestMarker("random-weight-zero-pick", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('WeightedChoice zero-pick skips zero-weight prefixes'"),
    RequiredBehaviorTestMarker("random-weight-tail", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('WeightedChoice max pick keeps tail weight reachable'"),
    RequiredBehaviorTestMarker("random-invalid-ranges", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('invalid ranges fail fast'"),
    RequiredBehaviorTestMarker("random-roll-overflow", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('RollMultiple rejects overflowing total'"),
    RequiredBehaviorTestMarker("random-probability-dice", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('probability dice weighted choice and shuffle'"),
    RequiredBehaviorTestMarker("random-gaussian-circle", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('gaussian and circle vectors'"),
    RequiredBehaviorTestMarker("random-gaussian-zero-state", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('Gaussian zero-state clamp stays finite'"),
    RequiredBehaviorTestMarker("random-non-finite", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('non-finite parameter validation'"),
    RequiredBehaviorTestMarker("random-bool-non-finite", "tests/nextpas.core.math/test_random/test_random.lpr", "T.Test('NextBool rejects non-finite probability'"),
    RequiredBehaviorTestMarker("noise-repeatability", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('noise repeatability'"),
    RequiredBehaviorTestMarker("noise-zero-seed", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('zero seed uses deterministic default'"),
    RequiredBehaviorTestMarker("noise-reference", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('noise reference vectors'"),
    RequiredBehaviorTestMarker("noise-invalid", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('noise invalid inputs'"),
    RequiredBehaviorTestMarker("noise-large-periodic", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('large periodic coordinates stay stable'"),
    RequiredBehaviorTestMarker("noise-negative-fractional", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('negative fractional coordinates wrap periodically'"),
    RequiredBehaviorTestMarker("noise-huge-lattice", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('huge finite lattice coordinates stay stable'"),
    RequiredBehaviorTestMarker("noise-fbm-coordinate", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('FBM rejects non-finite octave coordinates'"),
    RequiredBehaviorTestMarker("noise-fbm-amplitude", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('FBM rejects non-finite octave amplitude'"),
    RequiredBehaviorTestMarker("noise-fbm-accumulated", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('FBM rejects non-finite accumulated result'"),
    RequiredBehaviorTestMarker("noise-precision-ceiling", "tests/nextpas.core.math/test_noise/test_noise.lpr", "T.Test('precision ceiling follows stored Double value'"),
    RequiredBehaviorTestMarker("impl-simd-vec4f", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('vec4f simd helpers'"),
    RequiredBehaviorTestMarker("impl-simd-vec3f", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('vec3f simd helpers'"),
    RequiredBehaviorTestMarker("impl-simd-mat4f", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('mat4f simd helpers'"),
    RequiredBehaviorTestMarker("impl-simd-quatf", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('quatf simd helpers'"),
    RequiredBehaviorTestMarker("impl-simd-runtime-parity", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('simd helpers match public math semantics'"),
    RequiredBehaviorTestMarker("impl-simd-stable-edge-parity", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('simd dot length stable edge parity'"),
    ...
    RequiredBehaviorTestMarker("impl-simd-vec4f-lane-ieee-parity", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('simd vec4f lane IEEE parity'"),
    RequiredBehaviorTestMarker("impl-simd-vec4f-reduction-ieee-parity", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('simd vec4f reduction IEEE parity'"),
    RequiredBehaviorTestMarker("impl-simd-mat4f-mul-vec4f-ieee-parity", "tests/nextpas.core.math/test_impl_simd/test_impl_simd.lpr", "T.Test('simd mat4f mul vec4f IEEE parity'"),
...
def scan_facade_type_alias_compile_surface(root: Path) -> list[Finding]:
    ...
    direct_type_rules = set(ROOT_FACADE_DIRECT_TYPE_DEFINITIONS)
    ...
    for alias in sorted((compile_rules - alias_rules) - direct_type_rules):
        add_finding(
            findings,
...
def run_facade_root_import_contract_self_tests() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        path.write_text(
            ...
            "  nextpas.core.math;\n"
            "begin\n"
            "  T.Test('facade imports only root math unit', procedure begin end);\n"
            "end.\n",
            encoding="utf-8",
        )
        overview_path.write_text(
...
def run_behavior_marker_self_tests() -> None:
    ...
    cases = (
        (
            ...
            "begin\n"
            "  T.Test('constants', procedure begin end);\n"
            "end;\n",
            True,
        ),
        (
...
def scan_root_facade_contract(root: Path) -> list[Finding]:
    ...
    for name, target in REQUIRED_ROOT_FACADE_TYPE_ALIASES.items():
        if name.lower() in ROOT_FACADE_DIRECT_TYPE_DEFINITIONS:
            continue
    ...
    for routine in extract_public_routines(text):
        if routine.name.lower() in ROOT_FACADE_DIRECT_IMPLEMENTATIONS:
            continue
        ...
        if actual_body == normalize_pascal_expression(expected_call):
            continue
        if actual_body == normalize_pascal_expression(expected_proc_call):
            continue
        add_finding(
            findings,
