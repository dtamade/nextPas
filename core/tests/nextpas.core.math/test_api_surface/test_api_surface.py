...
REQUIRED_BEHAVIOR_TEST_MARKERS: tuple[RequiredBehaviorTestMarker, ...] = (
    ...
    RequiredBehaviorTestMarker("facade-public-member-compile-surface", "tests/nextpas.core.math/test_facade/test_facade.lpr", "T.Run('facade public member compile surface'"),
    ...
    RequiredBehaviorTestMarker("symbol-scope-expanded-common-symbols", "tests/nextpas.core.math/test_symbol_scope/test_symbol_scope.lpr", "T.Run('expanded scalar/trig common symbols'"),
    ...
    RequiredBehaviorTestMarker("scalar-predicate-direct-matrix", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Run('scalar predicate direct matrix contracts'"),
    ...
    RequiredBehaviorTestMarker("scalar-clamp-finite-bound-matrix", "tests/nextpas.core.math/test_scalar/test_scalar.lpr", "T.Run('scalar Clamp finite-bound matrix contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-measure-non-finite-type-matrix", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Run('vector measure non-finite type matrix contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-measure-non-finite-coverage-matrix", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Run('vector measure non-finite coverage matrix contracts'"),
    ...
    RequiredBehaviorTestMarker("vec-signed-zero-coverage-matrix", "tests/nextpas.core.math/test_vec/test_vec.lpr", "T.Run('vector signed-zero coverage matrix contracts'"),
    ...
    RequiredBehaviorTestMarker("mat-arithmetic-special-values", "tests/nextpas.core.math/test_mat/test_mat.lpr", "T.Run('matrix arithmetic special-value contracts'"),
