...
begin
  T := TTestSuite.Create('nextpas.core.id.uuidv7.same_timestamp_order_contract');
  T.Test('same timestamp UUIDv7 values sort by tail order', @TestSameTimestampSortsByRandomTail);
