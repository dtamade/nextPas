...
- Host Arch: arm64
- Backend: NEON
- Output Root: /tmp/neon/run
- Environment: /home/dtamade/projects/nextpas.core/tests/nextpas.core.simd/fixtures/native-evidence/native-evidence-neon-20260411-000000/environment.txt

## list-suites
[BUILD] OK
[TEST] Running: /tmp/neon/run/bin2/nextpas.core.simd.test --list-suites
[TEST] OK
[LEAK] OK

## DispatchAPI + PublicAbi
[BUILD] OK
[TEST] Running: /tmp/neon/run/bin2/nextpas.core.simd.test --suite=TTestCase_DispatchAPI,TTestCase_PublicAbi
[TEST] OK
[LEAK] OK

## Runtime Parity (TTestCase_NonX86BackendParity,TTestCase_DataPlane)
[BUILD] OK
[TEST] Running: /tmp/neon/run/bin2/nextpas.core.simd.test --suite=TTestCase_NonX86BackendParity,TTestCase_DataPlane
[TEST] OK
[LEAK] OK
...
[BUILD] OK
[TEST] Running: /tmp/neon/run/bin2/nextpas.core.simd.test --suite=TTestCase_DispatchAPI,TTestCase_DirectDispatch,TTestCase_DataPlane
[TEST] OK
[LEAK] OK
NONX86_IMPL_AUDIT_SUMMARY steps=6 native_evidence=skip targeted_output_root=/tmp/neon/run status=ok
