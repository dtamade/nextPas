...
DISPATCHAPI_FILE = ROOT / "tests" / "nextpas.core.simd" / "nextpas.core.simd.dispatchapi.nonx86.testcase.pas"
...
def main() -> int:
    ...
    routine_expectations: list[tuple[str, str, list[str]]] = [
        ...
        (direct_source, "TTestCase_DirectDispatch.Test_DirectDispatchTable_MultiBackend_WideBitwiseShiftMatrix_Parity", [
            ...
            "LDirectDispatch^.CoreVectors.AndNotI32x8",
            "VecI32x8AndNot",
            "LDirectDispatch^.CoreVectors.ShiftLeftI32x16",
            "VecI32x16ShiftRightArith",
            "VecI64x4ShiftRightArith",
            "LScalarTable.CoreVectors.ShiftRightArithI64x4",
        ]),
        (direct_source, "TTestCase_DirectDispatch.Test_DirectDispatchTable_MultiBackend_WideArithmeticMinMaxMatrix_Parity", [
            "LDirectDispatch^.CoreVectors.AddI32x8",
            "VecI32x8Mul",
            "LDirectDispatch^.CoreVectors.MaxU32x8",
            "LDirectDispatch^.CoreVectors.SubI64x4",
            "VecI32x16Mul",
            "LDirectDispatch^.CoreVectors.MinI32x16",
            "VecI64x8Add",
            "VecU64x8Add",
            "LDirectDispatch^.CoreVectors.SubU64x8",
        ]),
        (dispatchapi_source, "TTestCase_NonX86BackendParity.Test_WideSignedBitwiseShiftParity_IfAvailable", [
            "C_SHIFT32: array[0..8] of Integer = (-1, 0, 1, 7, 31, 32, 63, 64, 95)",
            "C_SHIFT64: array[0..7] of Integer = (-1, 0, 1, 7, 31, 63, 64, 95)",
            "Assigned(LBackendTable.CoreVectors.AndI32x8)",
            "Assigned(LBackendTable.CoreVectors.ShiftLeftI32x16)",
            "Assigned(LBackendTable.CoreVectors.ShiftRightArithI64x4)",
            "Assigned(LBackendTable.CoreVectors.AndI64x8)",
            "Assigned(LBackendTable.CoreVectors.NotI64x8)",
        ...
        (dispatchapi_source, "TTestCase_NonX86BackendParity.Test_WideCompareMaskParity_IfAvailable", [
            "Assigned(LBackendTable.CoreVectors.CmpEqI32x8)",
            "Assigned(LBackendTable.CoreVectors.CmpEqU32x8)",
            "Assigned(LBackendTable.CoreVectors.CmpEqI64x4)",
            "Assigned(LBackendTable.CoreVectors.CmpEqU64x4)",
            "Assigned(LBackendTable.CoreVectors.CmpEqI32x16)",
            "Assigned(LBackendTable.CoreVectors.CmpEqI64x8)",
            "AssertMask4HelperParity",
            "AssertMask8HelperParity",
            "AssertMask16HelperParity",
        ...
        (dispatchapi_source, "TTestCase_NonX86BackendParity.Test_WideIntegerArithmeticMinMaxParity_IfAvailable", [
            "Assigned(LBackendTable.CoreVectors.AddI32x8)",
            "Assigned(LBackendTable.CoreVectors.SubI32x8)",
            "Assigned(LBackendTable.CoreVectors.MulI32x8)",
            "Assigned(LBackendTable.CoreVectors.MinU32x8)",
            "Assigned(LBackendTable.CoreVectors.MaxU32x8)",
            "Assigned(LBackendTable.CoreVectors.AddI64x4)",
            "Assigned(LBackendTable.CoreVectors.SubI64x4)",
            "Assigned(LBackendTable.CoreVectors.MinI32x16)",
            "Assigned(LBackendTable.CoreVectors.MulI32x16)",
            "Assigned(LBackendTable.CoreVectors.MaxI32x16)",
            "Assigned(LBackendTable.CoreVectors.AddU32x16)",
            "Assigned(LBackendTable.CoreVectors.MulU32x16)",
            "Assigned(LBackendTable.CoreVectors.MaxU32x16)",
            "Assigned(LBackendTable.CoreVectors.AddI64x8)",
            "Assigned(LBackendTable.CoreVectors.SubI64x8)",
            "Assigned(LBackendTable.CoreVectors.SubU64x8)",
            "VecU32x8Min",
            "VecI32x16Mul",
            "VecI64x8Add",
            "VecI64x8Sub",
        ...
        (dataplane_source, "TTestCase_DataPlane.Test_DataPlane_CompareMaskSnapshot_Follows_CurrentDispatchSemantics", [
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.CmpLtI64x4)",
            ...
            "Assigned(LDataPlane^.Dispatch^.Mask.Mask8PopCount)",
            "data-plane dispatch Mask16PopCount should match scalar helper",
            "ScalarCmpLtI64x8",
            "ScalarMask16FirstSet",
            "LDirectDispatch^.CoreVectors.CmpLtI32x16",
        ]),
        (dataplane_source, "TTestCase_DataPlane.Test_DataPlane_WideBitwiseShiftSnapshot_Follows_CurrentDispatchSemantics", [
            ...
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.AndNotI32x16)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.ShiftLeftI32x16)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.AndI64x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.OrI64x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.XorI64x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.NotI64x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.ShiftRightI64x4)",
            ...
            "LDirectDispatch^.CoreVectors.AndI64x8",
            "LDirectDispatch^.CoreVectors.OrI64x8",
            "LDirectDispatch^.CoreVectors.XorI64x8",
            "LDirectDispatch^.CoreVectors.NotI64x8",
            "LDirectDispatch^.CoreVectors.ShiftRightI64x4",
        ]),
        (dataplane_source, "TTestCase_DataPlane.Test_DataPlane_WideArithmeticMinMaxSnapshot_Follows_CurrentDispatchSemantics", [
            "for LCaseIdx := 0 to 2 do",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.AddI32x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.MulI32x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.SubI32x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.AddU32x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.SubU32x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.MulU32x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.MinU32x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.MaxU32x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.AddI64x4)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.SubI64x4)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.AddU64x4)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.SubU64x4)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.AddI32x16)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.MinI32x16)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.MulI32x16)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.MinU32x16)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.AddI64x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.SubI64x8)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.MaxU32x16)",
            "Assigned(LDataPlane^.Dispatch^.CoreVectors.SubU64x8)",
            "ScalarAddI32x8",
            "ScalarAddU32x8",
            "ScalarSubU32x8",
            "ScalarMulU32x8",
            ...
            "ScalarSubI64x8",
            "ScalarMaxU32x16",
            "LDirectDispatch^.CoreVectors.AddU32x8",
            "LDirectDispatch^.CoreVectors.MulU32x8",
            "LDirectDispatch^.CoreVectors.MinU32x8",
            "LDirectDispatch^.CoreVectors.AddI64x4",
            "LDirectDispatch^.CoreVectors.SubI64x4",
            "LDirectDispatch^.CoreVectors.AddU64x4",
            "LDirectDispatch^.CoreVectors.SubU64x4",
            "LDirectDispatch^.CoreVectors.AddI32x16",
            "LDirectDispatch^.CoreVectors.MulI32x16",
            "LDirectDispatch^.CoreVectors.MinU32x16",
            "LDirectDispatch^.CoreVectors.SubI64x8",
            "LDirectDispatch^.CoreVectors.AddU64x8",
    ...
    document_expectations = [
        ...
        (
            ...
            [
                "table.CoreVectors.ShiftLeftU32x8 := @RISCVVShiftLeftU32x8;",
                "table.CoreVectors.ShiftRightU32x8 := @RISCVVShiftRightU32x8;",
