...
procedure DoAdd; begin GetDispatchTable^.BatchF32.ArrayAdd(@A[0], @B[0], @Dst[0], N); end;
procedure DoSub; begin GetDispatchTable^.BatchF32.ArraySub(@A[0], @B[0], @Dst[0], N); end;
procedure DoMul; begin GetDispatchTable^.BatchF32.ArrayMul(@A[0], @B[0], @Dst[0], N); end;
procedure DoDiv; begin GetDispatchTable^.BatchF32.ArrayDiv(@A[0], @B[0], @Dst[0], N); end;
procedure DoMin; begin GetDispatchTable^.BatchF32.ArrayMin(@A[0], @B[0], @Dst[0], N); end;
procedure DoMax; begin GetDispatchTable^.BatchF32.ArrayMax(@A[0], @B[0], @Dst[0], N); end;
procedure DoAbs; begin GetDispatchTable^.BatchF32.ArrayAbs(@A[0], @Dst[0], N); end;
procedure DoNeg; begin GetDispatchTable^.BatchF32.ArrayNeg(@A[0], @Dst[0], N); end;
procedure DoSqrt;
var i: Integer;
begin
  for i := 0 to N-1 do Dst[i] := Abs(A[i]);
  GetDispatchTable^.BatchF32.ArraySqrt(@Dst[0], @Dst[0], N);
end;
procedure DoAddScalar; begin GetDispatchTable^.BatchF32.ArrayAddScalar(@A[0], @Dst[0], N, 3.14); end;
procedure DoMulScalar; begin GetDispatchTable^.BatchF32.ArrayMulScalar(@A[0], @Dst[0], N, 2.5); end;
procedure DoClamp; begin GetDispatchTable^.BatchF32.ArrayClamp(@A[0], @Dst[0], N, -10.0, 25.0); end;
procedure DoFma; begin GetDispatchTable^.BatchF32.ArrayFma(@A[0], @B[0], @C[0], @Dst[0], N); end;
procedure DoAxpy; begin GetDispatchTable^.BatchF32.ArrayAxpy(2.5, @A[0], @B[0], @Dst[0], N); end;
procedure DoReduceSum;
var r: Single;
begin r := GetDispatchTable^.BatchF32.ReduceSum(@A[0], N); if r = 0 then; end;
procedure DoReduceDot;
var r: Single;
begin r := GetDispatchTable^.BatchF32.ReduceDot(@A[0], @B[0], N); if r = 0 then; end;
procedure DoReduceMin;
var r: Single;
begin r := GetDispatchTable^.BatchF32.ReduceMin(@A[0], N); if r = 0 then; end;
procedure DoReduceMax;
var r: Single;
begin r := GetDispatchTable^.BatchF32.ReduceMax(@A[0], N); if r = 0 then; end;
