...
W1 路径遗孤清理：9ab2e83fc 文档重组删除了 docs/simd 下 GOAL_TREE.md、checklist.md、
closeout.md、cpuinfo.md、architecture-guide.md、publicabi.md、publicabi.stability.md、
quickref.md、map.md、backend-truth.md、architecture-impl.md、pipeline.quickstart.md、
layering-implementation.md、intrinsics.neon.md 且未做内容合并；现存 docs/simd 与
tests/nextpas.core.simd/docs 对相应检查 token 集零命中、无重定向目标，故上述文档的
检查腿全部删除（活文件腿保留）。e42ac7416 将 intrinsics.x86.sse2.pas 重命名为
intrinsics.sse2.pas，该腿已重指向。canonical dispatch_slots_total=616 检查从
closeout.md 重定向到 tests/nextpas.core.simd/docs/interface_implementation_completeness.md。
"""
...
def check_no_stale_interface_completeness_snapshots(a_errors: list[str]) -> None:
    ...
    for l_rel in l_files:
        ...
        if l_rel == "tests/nextpas.core.simd/docs/interface_implementation_completeness.md":
...
def check_no_missing_legacy_simd_archive_refs(a_errors: list[str]) -> None:
    ...
    l_replacement = "docs/simd/README.md plus docs/simd/backends.md"
...
def check_batch_api_runtime_routing_truth(a_errors: list[str]) -> None:
    # quickref.md 腿已随 9ab2e83fc 文档删除移除（见模块 docstring）；README 腿保留。
...
def check_active_intrinsics_leaf_headers(a_errors: list[str]) -> None:
    l_active_leaf_tokens = {
        ...
        "src/nextpas.core.simd.intrinsics.sse2.pas": [
            "Disposition: STABLE",
