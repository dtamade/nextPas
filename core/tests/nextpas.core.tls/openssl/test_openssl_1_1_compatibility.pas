...
uses
  ...
  nextpas.core.tls.openssl.api.bn, nextpas.core.exception, nextpas.core.text, nextpas.core.text.format;
...
begin
  ...
  WriteLn('Pass rate: ', TextFormat('%.1f%%', [(PassedTests / TotalTests) * 100]));
  WriteLn;
