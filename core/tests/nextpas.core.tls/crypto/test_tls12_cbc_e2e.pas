...
uses
  ...
  nextpas.core.tls.crypto.tls12record, nextpas.core.base, nextpas.core.exception, nextpas.core.text.conv;
...
begin
  ...
  try
    ...
    WriteLn('  First line: ', Copy(UTF8BytesToString(LDecrypted), 1, 30));
    Halt(0);
  finally
    LSocket.Free;
  end;
