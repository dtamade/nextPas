...
begin
  ...
  LStream.Write(LRec1[0], Length(LRec1));
  LStream.Write(LRec2[0], Length(LRec2));
  LStream.Position := 0;
...
begin
  ...
  LStream.Write(LRec[0], Length(LRec));
  LStream.Position := 0;
...
begin
  ...
  LPlain := StringToUTF8Bytes('replay test');
...
begin
  ...
  LPlain := StringToUTF8Bytes('chacha replay');
...
begin
  ...
  LPlain := StringToUTF8Bytes('padding oracle test data here!!');
