...
{ 15-19: IPv6 + SO_LINGER/SO_REUSEPORT tests deferred — symbols not yet in main branch
  (platform_sockaddr_loopback6, platform_socket_resolve_ipv6, PLATFORM_SO_LINGER) }
