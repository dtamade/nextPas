program test_game;
{$mode objfpc}{$H+}
uses nextpas.core.exception, nextpas.core.base, nextpas.core.test, nextpas.core.audio.base, nextpas.core.audio.sfx.intf, nextpas.core.audio.game, nextpas.core.audio.device.null, nextpas.core.audio;
