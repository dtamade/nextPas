program test_event;
{$mode objfpc}{$H+}
uses SysUtils, Math, nextpas.core.base, nextpas.core.test, nextpas.core.audio.base, nextpas.core.audio.event.intf, nextpas.core.audio.event, nextpas.core.audio.spatial.intf, nextpas.core.audio;
