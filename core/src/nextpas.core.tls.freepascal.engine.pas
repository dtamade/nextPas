...
uses SysUtils, nextpas.core.base, nextpas.core.tls.base, nextpas.core.tls.engine; type TFreePascalEngine = class(TInterfacedObject, ISSLEngine) private FContext: ISSLContext;
