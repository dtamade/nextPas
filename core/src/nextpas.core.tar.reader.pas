...
begin
  ...
  // 朴素 NUL 截断：单次 SpanIndexOf → bytes.ops 单源 SIMD，零拷贝视图
...
begin
  ...
  begin
    ...
    begin
      ...
      AHeader.DevMajor := NumericField(FPos + C_TAR_OFF_DEVMAJOR, C_TAR_LEN_DEVMAJOR);
      AHeader.DevMinor := NumericField(FPos + C_TAR_OFF_DEVMINOR, C_TAR_LEN_DEVMINOR);
