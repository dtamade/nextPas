...
uses nextpas.core.text.conv, nextpas.core.text.format, nextpas.core.tls.winssl.base, nextpas.core.platform.windows.base, nextpas.core.platform.windows.ffi, nextpas.core.tls.base, nextpas.core.time,
...
begin
  ...
  LErrorInfo.Timestamp := nextpas.core.time.DateTimeNow;
