...
uses Classes; type // ======================================================================== // 简单 HTTP 客户端 // ======================================================================== TSimpleHTTPClient = class private FTimeout: Integer; // 超时时间 (毫秒);
...
uses nextpas.core.tls.base, nextpas.core.tls.net.hooks; // ======================================================================== // TSimpleHTTPClient // ======================================================================== constructor TSimpleHTTPClient.Create;
begin
  inherited Create;
  FTimeout := 10000;  // 10 秒
