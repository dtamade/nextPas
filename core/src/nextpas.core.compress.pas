 ...
 * @note Tar 已晋升独立 L2 nextpas.core.tar，兼容薄转发保留于 nextpas.core.compress.tar 经 archive.fs 单缝联邦（deprecated，新增请 uses nextpas.core.tar），本门面不再 re-export Tar 以守 L2→L0-L1 依赖（见 module-registry）。
 *}
