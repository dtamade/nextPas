...
{ ---- db-consolidation union: lane-only single-source helpers (owner bytes lane may reconcile).
  Kept so lane consumers (sentinel BYTES_OPS_SINGLE_SOURCE + BuilderCap*/BytesCalcGrowCap*/Ansi* family) compile. }
const
...
{ ---- db-consolidation union: lane-only implementations (see interface note). }
