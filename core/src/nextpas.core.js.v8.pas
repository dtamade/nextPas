...
function TJsV8Context.NewObject: TJsValue; begin EnsureNotClosed; Result:=JsPureHeapNewObject(FHeap); end;
function TJsV8Context.NewArray: TJsValue; begin EnsureNotClosed; Result:=JsPureHeapNewArray(FHeap); end;
