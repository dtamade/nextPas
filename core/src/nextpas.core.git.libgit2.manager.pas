unit nextpas.core.git.libgit2.manager;
...
type
  ...
  public
    ...
    function WorkDir: string; inline;
    function IsBare: Boolean; inline;
    ...
    function CheckoutBranch(const Branch: string): Boolean; inline;
    function CheckoutBranchEx(const Branch: string; Force: Boolean): Boolean;

    function Status: TStringArray; inline;
    function StatusEntries(const Filter: TGitStatusFilter): TGitStatusEntryArray;
    function IsClean: Boolean; inline;
    function HasUncommittedChanges: Boolean; inline;

    function ListRemotes: TStringArray; inline;
    function PullFastForward(const RemoteName: string; out Error: string): TGitPullFastForwardResult;
    function Diff(const AOldRef, ANewRef: string): TGitDiff; inline;
    function DiffEx(const AOldRef, ANewRef: string;
      const AOptions: TGitDiffOptions): TGitDiff; inline;
    function DiffWorkingTree(const ARef: string): TGitDiff; inline;
    function DiffWorkingTreeEx(const ARef: string;
      const AOptions: TGitDiffOptions): TGitDiff; inline;
    function RevWalk(const AStartRef: string; ALimit: Integer): TGitCommitArray;
    function Blame(const APath: string): TGitBlame; inline;
    function ConfigEntries: TGitConfigEntryArray; inline;
    procedure ApplyPatch(const APatchText: string); inline;
    procedure CheckoutPaths(const ARevspec: string; const APaths: TStringArray); inline;
    function WorkdirPatchText(const ARevspec: string; const APaths: TStringArray;
      AShowBinary: Boolean): string; inline;
  ...
  public
    ...
    function Message: string; inline;
    function ShortMessage: string; inline;
    function AuthorString: string;
    function CommitterString: string;
    function Time: TDateTime; inline;
    function ParentCount: Integer; inline;
  ...
  public
    ...
    function IsRemote: Boolean; inline;
    function IsTag: Boolean; inline;
  end;
...
var
  p, prev: string;
begin
  // Pure Pascal fallback first to avoid instability due to header signature differences
...
function TGitRepositoryImpl.Path: string; inline;
begin
  Result := FRepo.Path;
end;

function TGitRepositoryImpl.WorkDir: string; inline;
begin
  Result := FRepo.WorkDir;
end;

function TGitRepositoryImpl.IsBare: Boolean; inline;
begin
  Result := FRepo.IsBare;
end;

function TGitRepositoryImpl.IsEmpty: Boolean; inline;
begin
...
function TGitRepositoryImpl.CheckoutBranch(const Branch: string): Boolean; inline;
begin
  Result := FRepo.CheckoutBranch(Branch);
end;

function TGitRepositoryImpl.Status: TStringArray; inline;
begin
  Result := FRepo.Status;
end;

function TGitRepositoryImpl.IsClean: Boolean; inline;
begin
...
function TGitRepositoryImpl.HasUncommittedChanges: Boolean; inline;
begin
  Result := FRepo.HasUncommittedChanges;
end;

function TGitRepositoryImpl.Diff(const AOldRef, ANewRef: string): TGitDiff; inline;
begin
...
function TGitRepositoryImpl.DiffWorkingTree(const ARef: string): TGitDiff; inline;
begin
...
function TGitRepositoryImpl.Blame(const APath: string): TGitBlame; inline;
begin
  Result := FRepo.Blame(APath);
end;

function TGitRepositoryImpl.ConfigEntries: TGitConfigEntryArray; inline;
begin
  Result := FRepo.ConfigEntries;
end;

procedure TGitRepositoryImpl.ApplyPatch(const APatchText: string); inline;
begin
  FRepo.ApplyPatch(APatchText);
end;

procedure TGitRepositoryImpl.CheckoutPaths(const ARevspec: string; const APaths: TStringArray); inline;
begin
...
function TGitRepositoryImpl.ListRemotes: TStringArray; inline;
begin
...
function TGitCommitImpl.Message: string; inline;
begin
  Result := FCommit.Message;
end;

function TGitCommitImpl.ShortMessage: string; inline;
begin
...
function TGitCommitImpl.Time: TDateTime; inline;
begin
  Result := FCommit.Time;
end;

function TGitCommitImpl.ParentCount: Integer; inline;
begin
...
function TGitReferenceImpl.Name: string; inline;
begin
  Result := FRef.Name;
end;

function TGitReferenceImpl.ShortName: string; inline;
begin
...
function TGitReferenceImpl.IsBranch: Boolean; inline;
begin
  Result := (Pos('refs/heads/', FRef.Name) = 1);
end;

function TGitReferenceImpl.IsRemote: Boolean; inline;
begin
  Result := (Pos('refs/remotes/', FRef.Name) = 1);
end;

function TGitReferenceImpl.IsTag: Boolean; inline;
begin
...
function TGitRemoteImpl.Name: string; inline;
begin
  Result := FRemote.Name;
end;

function TGitRemoteImpl.URL: string; inline;
begin
  Result := FRemote.URL;
end;

function TGitRemoteImpl.Fetch: Boolean; inline;
begin
