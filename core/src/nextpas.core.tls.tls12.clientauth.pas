...
uses nextpas.core.base, nextpas.core.tls.x509, nextpas.core.tls.tls12.wire,
  nextpas.core.tls.tls13.servercertverify; type TTLS12ClientCertConfig = record CertificateDER: TBytes;
