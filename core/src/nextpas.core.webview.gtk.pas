...
procedure TGtkWebview.HandleWindowEvent(const AEvent: TWindowEvent); begin if FClosed then Exit; case AEvent.Kind of weCloseRequested,weClosed: Close; weScaleChanged: begin FScale:=AEvent.NewScale.Factor; FireScaleHandlers(FOnScaleChanged, FScale); end; weResized: ; end; end;
