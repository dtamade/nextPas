...
type
  ...
  TDbSqlSlotArray = array of Integer;
...
function SqlScanCore(const ASql: string; const AD: TDbSqlScanDialect;
  const APhChar: AnsiChar; const AMode: TDbSqlScanMode;
  const AIndexes: array of Integer; const ASuffix: string;
  out ARewritten: string; out ASlots: TDbSqlSlotArray): Integer;
var
  LB: IStringBuilder;
  I: Integer;
  C: AnsiChar;
