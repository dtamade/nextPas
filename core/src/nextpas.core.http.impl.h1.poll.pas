    ...
    begin
      ...
      begin
        ...
        begin
          ...
          nextpas.core.bytes.ops.BytesCopy(@AState.FPending[1], @AState.FBuf[LConsumed], LN - LConsumed); // perf: inline single Move via bytes.ops.BytesCopy single source (zero-copy, INV-5, red-line 1/2)
        end;
      end;
      end;
    end;
