...
function platform_poller_create(out APoller: TPlatformPoller): Int32; begin FillChar(APoller, SizeOf(APoller), 0); Result := PLATFORM_ERR_UNSUPPORTED; end;
function platform_poller_close(var APoller: TPlatformPoller): Int32; begin Result := PLATFORM_ERR_UNSUPPORTED; end;
function platform_poller_add(var APoller: TPlatformPoller; AFd: PtrUInt; AEvents: TPlatformPollEvents; AUserData: Pointer): Int32; begin Result := PLATFORM_ERR_UNSUPPORTED; end;
function platform_poller_modify(var APoller: TPlatformPoller; AFd: PtrUInt; AEvents: TPlatformPollEvents; AUserData: Pointer): Int32; begin Result := PLATFORM_ERR_UNSUPPORTED; end;
function platform_poller_remove(var APoller: TPlatformPoller; AFd: PtrUInt): Int32; begin Result := PLATFORM_ERR_UNSUPPORTED; end;
