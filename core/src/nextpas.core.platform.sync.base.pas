...
const
  ...
  PTHREAD_CONDVAR_SIZE = WINDOWS_CONDVAR_SIZE;
  {$ELSE}
  PTHREAD_MUTEX_SIZE   = 64;
  PTHREAD_RWLOCK_SIZE  = 64;
  PTHREAD_CONDVAR_SIZE = 64;
  {$ENDIF}
...
type
  ...
  TPlatformCondVar = record
    case Integer of
      ...
      1: (FOpaque: array[0..PTHREAD_CONDVAR_SIZE - 1] of Byte);
  end;
