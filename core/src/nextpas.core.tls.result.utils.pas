...
uses nextpas.core.tls.base, nextpas.core.text.conv; type TBooleanFunc = function: Boolean;
...
uses nextpas.core.tls.exceptions, nextpas.core.text.conv; class function TResultUtils.FromBool(ASuccess: Boolean;
