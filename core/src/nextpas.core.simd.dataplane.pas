...
begin
  ...
  aDataPlane^.VecF32x4AddPtr := Pointer(aDispatch^.CoreVectors.AddF32x4);
  aDataPlane^.VecI16x32AddPtr := Pointer(aDispatch^.CoreVectors.AddI16x32);
  aDataPlane^.VecU32x16MulPtr := Pointer(aDispatch^.CoreVectors.MulU32x16);
  aDataPlane^.VecU64x8AddPtr := Pointer(aDispatch^.CoreVectors.AddU64x8);
  aDataPlane^.VecU8x64MaxPtr := Pointer(aDispatch^.CoreVectors.MaxU8x64);

  aDataPlane^.MemEqualPtr := Pointer(aDispatch^.Memory.Equal);
  aDataPlane^.MemFindBytePtr := Pointer(aDispatch^.Memory.FindByte);
  aDataPlane^.MemDiffRangePtr := Pointer(aDispatch^.Memory.DiffRange);
  aDataPlane^.SumBytesPtr := Pointer(aDispatch^.Memory.SumBytes);
  aDataPlane^.CountBytePtr := Pointer(aDispatch^.Memory.CountByte);
  aDataPlane^.BitsetPopCountPtr := Pointer(aDispatch^.Memory.BitsetPopCount);
  aDataPlane^.Utf8ValidatePtr := Pointer(aDispatch^.Memory.Utf8Validate);
  aDataPlane^.AsciiIEqualPtr := Pointer(aDispatch^.Memory.AsciiIEqual);
  aDataPlane^.BytesIndexOfPtr := Pointer(aDispatch^.Memory.BytesIndexOf);
  aDataPlane^.MemCopyPtr := Pointer(aDispatch^.Memory.Copy);
  aDataPlane^.MemSetPtr := Pointer(aDispatch^.Memory.Fill);
  aDataPlane^.ToLowerAsciiPtr := Pointer(aDispatch^.Memory.ToLowerAscii);
  aDataPlane^.ToUpperAsciiPtr := Pointer(aDispatch^.Memory.ToUpperAscii);
  aDataPlane^.MemReversePtr := Pointer(aDispatch^.Memory.Reverse);
  aDataPlane^.MinMaxBytesPtr := Pointer(aDispatch^.Memory.MinMaxBytes);
  aDataPlane^.VecF32x4SubPtr := Pointer(aDispatch^.CoreVectors.SubF32x4);
  aDataPlane^.VecF32x4MulPtr := Pointer(aDispatch^.CoreVectors.MulF32x4);
  aDataPlane^.VecF32x4DivPtr := Pointer(aDispatch^.CoreVectors.DivF32x4);
  aDataPlane^.VecF32x4AbsPtr := Pointer(aDispatch^.CoreVectors.AbsF32x4);
  aDataPlane^.VecF32x4SqrtPtr := Pointer(aDispatch^.CoreVectors.SqrtF32x4);
  aDataPlane^.VecF32x4MinPtr := Pointer(aDispatch^.CoreVectors.MinF32x4);
  aDataPlane^.VecF32x4MaxPtr := Pointer(aDispatch^.CoreVectors.MaxF32x4);
  aDataPlane^.VecF32x4DotPtr := Pointer(aDispatch^.CoreVectors.DotF32x4);
  aDataPlane^.VecF32x4SplatPtr := Pointer(aDispatch^.CoreVectors.SplatF32x4);
  aDataPlane^.VecF32x4CmpEqPtr := Pointer(aDispatch^.CoreVectors.CmpEqF32x4);
  aDataPlane^.VecF32x4FmaPtr := Pointer(aDispatch^.CoreVectors.FmaF32x4);
end;
