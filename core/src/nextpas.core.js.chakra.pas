...
function TJsChakraContext.Global: TJsValue; begin EnsureNotClosed; Result:=JsObjectValue; end;
...
function TJsChakraContext.NewObject: TJsValue; begin EnsureNotClosed; Result:=JsObjectValue; end;
function TJsChakraContext.NewArray: TJsValue; begin EnsureNotClosed; Result:=JsArrayValue; end;
...
function TJsChakraContext.HasProp(const AObj: TJsValue; const AName: string): Boolean; begin EnsureNotClosed; Result:=False; end;
function TJsChakraContext.DeleteProp(const AObj: TJsValue; const AName: string): Boolean; begin EnsureNotClosed; Result:=False; end;
function TJsChakraContext.GetKeys(const AObj: TJsValue): TJsStringArray; begin EnsureNotClosed; Result:=nil; end;
...
function TJsChakraContext.GetProp(const AObj: TJsValue; const AName: string): TJsValue; begin EnsureNotClosed; Result:=JsUndefinedValue; end;
procedure TJsChakraContext.SetProp(const AObj: TJsValue; const AName: string; const AVal: TJsValue); begin EnsureNotClosed; end;
...
procedure TJsChakraContext.Close; begin if FClosed then Exit; FClosed:=True; end;
