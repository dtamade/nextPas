...
begin
  ...
  LResults := TBenchSuite.Create('BasicDemo')
  ...
  LResults := TBenchSuite.Create('ConfigDemo')
  ...
  LResults := TBenchSuite.Create('BaselineDemo')
    .Add('StringConcat', @BenchStringConcat)
    .Add('ArraySum', @BenchArraySum)
  ...
  LResults := TBenchSuite.Create('FilterDemo')
    .Add('StringConcat', @BenchStringConcat)
    .Add('ArraySum', @BenchArraySum)
    .Add('MathOperations', @BenchMathOperations)
    .SetFilter('String')
  ...
  LResults := TBenchSuite.Create('MemoryDemo')
  ...
  LResults := TBenchSuite.Create('JSONDemo')
    .Add('StringConcat', @BenchStringConcat)
    .Add('ArraySum', @BenchArraySum)
    .Run;
  LResults.SaveToJSON('build/benchmark_results.json');

  WriteLn;
  WriteLn('JSON report saved to: build/benchmark_results.json');

  WriteLn;
  WriteLn('--- Example 7: Generate HTML Report ---');
  LResults := TBenchSuite.Create('HTMLDemo')
    .Add('StringConcat', @BenchStringConcat)
    .Add('ArraySum', @BenchArraySum)
    .Add('MathOperations', @BenchMathOperations)
    .Run;
  LResults.SaveToHTML('build/benchmark_results.html');

  WriteLn;
  WriteLn('HTML report saved to: build/benchmark_results.html');
