...
Write-Output 'truth=ci-matrix; documented 24 platform gates (+pipe); not full-host Windows parity'
...
Write-Output "truth=ci-matrix; gates_passed=$pass; gates_failed=$fail; scope=documented-24-platform-gate-set"
