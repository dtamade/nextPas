# Task Plan: http server trailer-complete chunked partial follow-up headers bridge

## Goal

继续留在 `3/6 H1 正确性加固` 主线，这一刀继续收口 keep-alive
request-tail contract，把 trailer-complete chunked follow-up partial headers 从
...
- [x] 缩小剩余高价值缺口，选定 trailer-complete chunked partial follow-up headers bridge
...
- 证据要求：
  - 新增 trailer-complete chunked partial follow-up headers bridge tests GREEN
