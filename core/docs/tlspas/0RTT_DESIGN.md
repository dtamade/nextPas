...
- `bench_tlspas_hrr` 64 项 + demo S35：`MessageHash 2.7/4.1µs Patch 2.7/1.7µs P256 2.39ms Transcript 6.2µs EarlyData 28/29µs EOED 342ns Policy 3.4ns Fingerprint 10µs Replay 1.2µs Store 1.4µs Stats 86ns IsReplayed 7µs FileStore 200µs KvStore 69µs ServerDecide 3.2µs Observer 3.2µs Adaptive 1.9ns AdaptiveObserverDecide 3.5µs AdaptiveObserverMax 95ns Header 4ns HttpHeader 4ns HttpStream nil 21ns HttpRequest 81ns Middleware 433ns IsThrottled 188ns AdaptiveMiddleware 648ns MetricsFormat 3.0µs LogLine 5.8µs Pressure 2.2µs Prometheus 7.8µs Registry 2×17µs Cached 120ns/7µs RegistryCached 150ns/17µs Handler 500ns TraceParse 150ns TraceFormat 200ns ShouldSample 20ns TraceMiddleware 600ns SpanExport 50ns SpanJSON 1µs Tracez 600ns AdaptiveSampling 2ns AdaptiveTracer 20ns OTLP 1µs Gauge 7µs SetRate 150ns Snapshot 200ns ConfigEnv 887ns Health 200ns HealthProm 1µs Append 7µs ClientIsIdempotent 24ns ClientIsEarly 88ns ClientShouldRetry 139ns ClientClone 2.0µs ClientAutoMark 1.8µs ClientAutoRetry 2.0µs`，`P384 741ms` 单采。
