...
**最后更新**：2026-08-28  
**当前版本**：**1.43**（S49 装载探针快照全 inline）（S48 Win32 窗口壳薄转发全 inline）（S47 调度与状态薄转发全 inline）（S46 桥协议薄转发全 inline）（S45 窗口壳薄转发全 inline）（S44 Builder 全 inline，14+7 全路径 inline，零重复）  
