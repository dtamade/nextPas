...
**最后更新**：2026-08-30
**版本**：1.90（S97—— 跨平台文档与 loader 纪律冻结：`CONTRACT 1.88→1.90` 跨平台诚实收口（`linux GTK 真实现 / windows WebView2 wine可交互 / macOS WK 桩冻结 + Darwin 真实现预留`），`README/ROADMAP/BACKENDS/PARITY` 时效一致，`demo` 404 卡保留，`loader` 唯一触 `platform.dl` 纪律冻结；`fpc -vh` 0 hint、`grep TODO/FIXME` 0、`hygiene` 双 pass、13 gates 全绿 heaptrc 0；Production Ready 保持）+ 承接 S96
