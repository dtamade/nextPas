...
**版本**：1.0rc（11 单元 pure.base 单源 352 行 + Close 幂等 + 5 gate 全绿，M3b 均值同步，与 CONTRACT 1.0rc/BENCHMARKS 1.3 对齐，18 份对齐）
...
| 2026-08-31 | 0.10 | 文档完整性修复：BENCHMARKS 1.3 同步本次实测均值（Eval/small ~660ns / Eval/host ~1.5µs 加权 / B/op 18/176 / Value 零分配）+ pure.base 352 行阈值 550 内统一，18 份对齐 |
