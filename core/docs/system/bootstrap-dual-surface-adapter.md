...
| `Format`, `SameText`, `IntToStr` | minimal live SysUtils facade | **owner is `nextpas.core.text.conv`** for Format/SameText/IntToStr/Trim; `system.sysutils` only re-exports. No broad SysUtils clone |
