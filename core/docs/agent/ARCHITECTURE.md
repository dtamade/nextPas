...
现状（2026-09-11 校准 + 2026-09-12 工厂子域收口 + 2026-09-12 跨域门禁修复 + 2026-09-03 单源/预算/看门狗精修）：`provider.common` 291+565+110+520 / `provider.openai` 159+346+233+360+271 / `provider.openai.responses` 256+308+246+442 / `provider.anthropic` 398+451+197+333 —— provider 域 15/15 <800 全达标（含 fake 407；openai 工厂 5 域，encode 346 -8 单源）；`base` 251+587+474 + `slotmap` 140 + `deltabuilder` 135 + `snapshot` 84 + `streambox` 131（托管逐项赋值）/ `loop` 57+96+166+191+690 / `transport.http` 73+197+464=734 / `hedge` 590 / `session` 552 / `tools` 523 / `quota` 186 / `pricing` 146；总量 13998（`wc -l core/src/nextpas.core.agent.*.pas`）。
