...
现状（2026-09-03 json 显式依赖收口 + 有界快照/流式盒）：`provider.common` 291+565+110+520 / `provider.openai` 327/351/233/360 / `provider.openai.responses` 257/308/246/442 / `provider.anthropic` 398/451/197/333 —— provider 域 14/14 <800 全达标（含 fake 407）；`base` 250+587+414 + `slotmap` 145 + `deltabuilder` 128 + `snapshot` 84 + `streambox` 131（托管逐项赋值）/ `loop` 57+97+122+187+681 / `transport.http` 73+197+464=734 / `hedge` 570 / `session` 552；总量 13665。
