...
**最后更新**：2026-09-02
**版本**：1.6.1（硬化·codec四族闭环：`87=31+56` 四件套 `base L0 only / intf 别名复用0001 / impl Probe≤4KB bytes.ops单源 STUB零分配 / facade inline自注册` 对 `codec.flac/mp3/vorbis/opus` 12+12 文件硬化，`bytes.ops` 单源去 `base.utils` 双源，守 L0-L3 与四件套独立演进；`1.6.0 bus` 独立化沿用）
