...
> 最后更新: 2026-06-07 | 本轮证据: lockfree 38/38 + debug 38/38 + adjacent atomic 34/34, heaptrc 0
...
| `lockfree` | 无锁 (MPMC/SPSC/MPSC/Stack/Deque) | ✅ 完成/强化中 (38 default + 38 debug + 8 stress, SPSC batch partial-progress contract, Close wait/timeout wake contract, MPMC single-slot sequence states, managed-type rejection cleanup, stack/deque query contract, tagged-ptr ABA) |
