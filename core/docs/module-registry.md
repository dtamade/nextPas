...
| `window` | L2 | cross-platform window/surface shell | `nextpas.core.window` | L0-L1 plus platform.dl | focused-runtime |
| `app` | L3 | application shell over webview | `nextpas.core.app` | L0-L2 plus webview/json owners; platform.dl | focused-runtime |
