...
> **Status**: **H3-5 done** → **Q 线 Q0–Q5 done**（Maintenance + 可选 land）
> **Date**: 2026-07-20
...
**Current execution line**: **Q 线 Q0–Q5 done**（[`quality-parity.md`](quality-parity.md)）；T2 inventory [`t2-inventory.md`](t2-inventory.md)；bench [`bench-envelope.md`](bench-envelope.md) — **not R9**.
