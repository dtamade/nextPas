...
**首证**：GHA run [29751744779](https://github.com/dtamade/nextPas/actions/runs/29751744779) · 5/5 gates · **24** cases（U2 前）· `b824a31ce`。  
U2 后 wine 最小生产集 **25**（fs +ReadAt）；host-windows 复证待下次 `test-windows-runtime`。
