...
> 📌 **历史评估快照**。源文件行数、测试计数、版本号以 `CONTRACT.md` / `README.md`（当前 v8.7）为准。
> 文内 P1–P3 改进项状态表在评估当时有效；接口拆分（F7）仍暂缓，见 CONTRACT §10.1。
...
| 优先级 | 改进项 | 工作量 | 状态 |
|--------|--------|--------|------|
| P1 | SysUtils 违规修复 | 0.5h | ✅ 已完成 |
| P2 | CheckArrayEqual 多差异报告 | 2h | ✅ 已完成 |
| P2 | ToBeInstanceOf 类型检查 | 1h | ✅ 已完成 |
| P2 | Mock 参数捕获器 | 3h | ✅ 已完成 |
| P3 | 彩色 diff 输出 | 4h | ✅ 已完成 |
| P3 | 性能回归 CI | 4h | ✅ test_perf_bench + perf-regression-check.sh |
| P3 | 接口拆分 | 8h | ⏸️ 暂缓（向后兼容风险高） |

**总计**: 6/7 项完成 (P1+P2 全清, P3 完成 2/3)
