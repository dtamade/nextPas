...
- **Windows x86_64**: durable **`ci-matrix`** for documented **24 platform gates**
  ...
  `pipe` PASS on run 29729281116 (pass=25 fail=0 with mem.host).
...
Promoted with `pipe` after GHA PASS platform.pipe (run 29729281116) + prior args
promote. Optional **mem.host_runtime** is mem-owned.
