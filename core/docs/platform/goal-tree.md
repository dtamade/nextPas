...
| P5 Tier 2 targets | Windows aarch64, Linux riscv64/arm32, FreeBSD/Android | riscv64/aarch64/arm32: 13-module compile gate + QEMU runtime smoke (18 tests each) | Windows aarch64; FreeBSD/Android |
