...
| Windows documented facade matrix | **ci-matrix** (21 platform) | Suite dirs through +info +which + iocp + 3 real gates; GHA run 29721371136 @ `0cb2471bc` (pass=22 with mem.host). |
