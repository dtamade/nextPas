...
- [Consumer contract audit](consumer-contract-audit.md) records readiness and
  completion consumer lanes.
- Existing `../platform-ffi-*` documents remain ABI evidence and migration
  references until they are folded into this directory.
