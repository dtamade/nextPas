...
| Gap | Severity | Notes |
|-----|----------|--------|
| Windows beyond documented 24 platform gates | **P1** | Full AcceptEx-ConnectEx depth / modules outside platform list not in matrix |
...
| Windows x86_64 | **`ci-matrix` for 24 platform gates** + wine 24 secondary | expand candidates one-at-a-time; keep wine + GHA green |
