...
| 2026-07-20 | **Batch-22**: watch smoke detects Wine vs real Windows; create/delete still soft residual on both (GHA RDCW delivery not observed; timeout/multi-dir hard). |
