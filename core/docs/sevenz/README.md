...
- Focused gate: `make -C core/tests/nextpas.core.sevenz/test_sevenz clean test`
  (152 tests: UTF conversion edge cases, FILETIME, LZMA2 round trips incl. stored-fallback
