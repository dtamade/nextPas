...
3. Windows native async smoke（fail-closed on Windows CI）：`bash core/scripts/async-windows-native-smoke.sh`
4. Windows smoke streak 观测：`bash core/scripts/async-windows-smoke-streak.sh`
