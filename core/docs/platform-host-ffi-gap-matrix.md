...
- Android `platform.files` now has a forced Android compile gate in
  ...
  stat/lstat/fstat. Android `platform_dir_read` remains an explicit unsupported
  boundary until a dedicated directory enumeration ABI slice lands. This is
