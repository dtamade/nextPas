# ROADMAP 历史快照 — Era 0 至 R2 residual（2026-07-26 冻结）

> 本文件是 2026-07-26 路线图重构前 `ROADMAP.md` 的完整快照（原 1220 行）。
> 所有已完成 Era/Wave 的 Do/Done when/Gates/Evidence 细节以此为准；**不是 backlog**。
> 当前前进路线只看 [`../ROADMAP.md`](../ROADMAP.md)。
