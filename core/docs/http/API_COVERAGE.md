...
- 2026-06-06 API 对标结论：
  ...
  - 本轮补齐：新增 `NewRequest(Method, Url, Headers, Body, ContentLength)` public
    ...
    helper contract、facade 可见性和 `IHttpClient.Do_` live header/body 发送路径。
