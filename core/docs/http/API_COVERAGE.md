...
1. client chunked response and close-delimited response coverage.
2. transport registry / protocol ownership design before any H2/H3 expansion.
...
4. direct `TChunkedWriter` focused tests if that helper remains a stable implementation surface.
