...
| `http.base`                                    | `THttpVersion`, `THttpMethod`, `THttpStatus`, `EHttpError`, `TUrl`, `THttpClientOptions.Default`, `THttpServerOptions.Default`, `TTcpServerBackend` / backend constants re-export | focused               | `test_http_base`, `test_http_contract`                                            | Add `EHttpError` code/category assertion if error contract is kept public.                                                |
