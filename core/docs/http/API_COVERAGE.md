...
| `IHttpRouter` / `THttpRouter`                  | handle/use/get/post/put/delete/serve, params, wildcard, method dispatch, 404/405                                                                                                   | focused + integration | `test_http_router`, `test_http_contract`, `test_http_integration`                 | Decide whether `Patch/Head/Options` convenience methods belong in public router API.                                      |
