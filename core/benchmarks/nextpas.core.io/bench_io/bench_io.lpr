...
begin
  ...
  LDst := CreateBytesStream(65536); LW := CreateBufferedWriter(LDst, 4096);
  LRem := 65536;
...
begin
  ...
  LSuite.Add('Copy/64KB', @BenchCopy64KB).Add('BufReader/64KB', @BenchBufferedReader64KB).Add('BufWriter/64KB', @BenchBufferedWriter64KB);
