...
procedure CheckImportedKnownFieldMemberCallDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedKnownFieldMemberCall;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-known-field-member-call-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.invalid-call-shape') then
      Fail('unexpected-imported-known-field-member-call-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-known-field-member-call-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Value', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-known-field-member-call-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-known-field-member-call-semantic-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-known-field-member-call-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-known-field-member-call-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedInheritedKnownFieldMemberCallDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedInheritedKnownFieldMemberCall;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedInheritedKnownFieldMemberCall',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-inherited-known-field-member-call-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.invalid-call-shape') then
      Fail('unexpected-imported-inherited-known-field-member-call-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-inherited-known-field-member-call-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Value', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-inherited-known-field-member-call-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-inherited-known-field-member-call-semantic-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-inherited-known-field-member-call-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-inherited-known-field-member-call-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceKnownFieldMemberCallStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedKnownFieldMemberCall;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedKnownFieldMemberCall',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-known-field-member-call-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-known-field-member-call-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-known-field-member-call-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-known-field-member-call-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceInheritedKnownFieldMemberCallStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedInheritedKnownFieldMemberCall;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedInheritedKnownFieldMemberCall',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-inherited-known-field-member-call-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-inherited-known-field-member-call-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-inherited-known-field-member-call-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-inherited-known-field-member-call-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedKnownPropertyMemberCallDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedKnownPropertyMemberCall;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedKnownPropertyMemberCall',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-known-property-member-call-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.invalid-call-shape') then
      Fail('unexpected-imported-known-property-member-call-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-known-property-member-call-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Value', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-known-property-member-call-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-known-property-member-call-semantic-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-known-property-member-call-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-known-property-member-call-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedInheritedKnownPropertyMemberCallDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedInheritedKnownPropertyMemberCall;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedInheritedKnownPropertyMemberCall',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-inherited-known-property-member-call-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.invalid-call-shape') then
      Fail('unexpected-imported-inherited-known-property-member-call-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-inherited-known-property-member-call-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Value', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-inherited-known-property-member-call-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-inherited-known-property-member-call-semantic-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-inherited-known-property-member-call-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-inherited-known-property-member-call-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceKnownPropertyMemberCallStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedKnownPropertyMemberCall;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedKnownPropertyMemberCall',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-known-property-member-call-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-known-property-member-call-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-known-property-member-call-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-known-property-member-call-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceInheritedKnownPropertyMemberCallStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedInheritedKnownPropertyMemberCall;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedInheritedKnownPropertyMemberCall',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-inherited-known-property-member-call-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-inherited-known-property-member-call-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-inherited-known-property-member-call-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-inherited-known-property-member-call-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckDelphiStyleGenericMemberCallBinding;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  SourceText :=
    'program DelphiGenericVar;' + LineEnding +
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('delphi-generic-unexpected-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('delphi-generic-missing-model');
    if not SameText(Model.Status, 'ready') then
      Fail('delphi-generic-model-status:' + Model.Status);
    if Model.BindingCount < 1 then
      Fail('delphi-generic-binding-count:' + IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
    UnitGraph.Free;
...
procedure CheckGenericTypeMismatchDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  SourceText :=
    'program GenericTypeMismatch;' + LineEnding +
    '{$mode objfpc}{$H+}' + LineEnding +
    'type' + LineEnding +
    '  generic TBox<T> = class' + LineEnding +
    '    procedure Put(const Value: T);' + LineEnding +
    ...
    'var' + LineEnding +
    '  Box: TIntBox;' + LineEnding +
    'begin' + LineEnding +
    '  Box.Put(' + #39 + 'hello' + #39 + ');' + LineEnding +
    'end.' + LineEnding;
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('generic-type-mismatch-expected-diagnostic');
  finally
    Model.Free;
    Analyzer.Free;
    UnitGraph.Free;
...
procedure CheckGenericMultiParamBinding;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  SourceText :=
    'program GenericMultiParam;' + LineEnding +
    '{$mode objfpc}{$H+}' + LineEnding +
    'type' + LineEnding +
    ...
    'end;' + LineEnding +
    'type' + LineEnding +
    '  TStrIntDict = specialize TDict<String, Integer>;' + LineEnding +
    'var' + LineEnding +
    '  Dict: TStrIntDict;' + LineEnding +
    'begin' + LineEnding +
    '  Dict.Add(' + #39 + 'key' + #39 + ', 42);' + LineEnding +
    'end.' + LineEnding;
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('generic-multi-param-unexpected-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('generic-multi-param-missing-model');
    if Model.BindingCount < 1 then
      Fail('generic-multi-param-binding-count:' + IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
    UnitGraph.Free;
...
procedure CheckGenericMultiParamTypeMismatch;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  SourceText :=
    'program GenericMultiParamMismatch;' + LineEnding +
    '{$mode objfpc}{$H+}' + LineEnding +
    'type' + LineEnding +
    '  generic TDict<K, V> = class' + LineEnding +
    '    procedure Add(const Key: K; const Value: V);' + LineEnding +
    ...
    '  Dict: TStrIntDict;' + LineEnding +
    'begin' + LineEnding +
    '  Dict.Add(42, ' + #39 + 'value' + #39 + ');' + LineEnding +
    'end.' + LineEnding;
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('generic-multi-param-mismatch-expected-diagnostic');
  finally
    Model.Free;
    Analyzer.Free;
    UnitGraph.Free;
...
procedure CheckGenericMultipleMethodsBinding;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  SourceText :=
    'program GenericMultipleMethods;' + LineEnding +
    '{$mode objfpc}{$H+}' + LineEnding +
    'type' + LineEnding +
    '  generic TContainer<T> = class' + LineEnding +
    '    procedure Add(const Item: T);' + LineEnding +
    '    function Count: Integer;' + LineEnding +
    '  end;' + LineEnding +
    'procedure TContainer.Add(const Item: T);' + LineEnding +
    'begin' + LineEnding +
    'end;' + LineEnding +
    'function TContainer.Count: Integer;' + LineEnding +
    'begin' + LineEnding +
    '  Result := 0;' + LineEnding +
    'end;' + LineEnding +
    'type' + LineEnding +
    '  TIntContainer = specialize TContainer<Integer>;' + LineEnding +
    'var' + LineEnding +
    '  C: TIntContainer;' + LineEnding +
    'begin' + LineEnding +
    '  C.Add(1);' + LineEnding +
    '  C.Count;' + LineEnding +
    'end.' + LineEnding;
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('generic-multi-methods-unexpected-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('generic-multi-methods-missing-model');
    if Model.BindingCount < 2 then
      Fail('generic-multi-methods-binding-count:' + IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
    UnitGraph.Free;
...
procedure CheckGenericDefaultParamInteraction;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  SourceText :=
    'program GenericDefaultParam;' + LineEnding +
    '{$mode objfpc}{$H+}' + LineEnding +
    'type' + LineEnding +
    '  generic TStore<T> = class' + LineEnding +
    '    procedure Save(const Value: T; Flag: Boolean = True);' + LineEnding +
    '  end;' + LineEnding +
    'procedure TStore.Save(const Value: T; Flag: Boolean = True);' + LineEnding +
    'begin' + LineEnding +
    'end;' + LineEnding +
    'type' + LineEnding +
    '  TIntStore = specialize TStore<Integer>;' + LineEnding +
    'var' + LineEnding +
    '  S: TIntStore;' + LineEnding +
    'begin' + LineEnding +
    '  S.Save(42);' + LineEnding +
    'end.' + LineEnding;
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('generic-default-param-unexpected-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('generic-default-param-missing-model');
    if Model.BindingCount < 1 then
      Fail('generic-default-param-binding-count:' + IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
    UnitGraph.Free;
...
procedure CheckGenericInheritedMethodBinding;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  SourceText :=
    'program GenericInherited;' + LineEnding +
    '{$mode objfpc}{$H+}' + LineEnding +
    'type' + LineEnding +
    '  generic TBase<T> = class' + LineEnding +
    '    procedure DoBase(const X: T);' + LineEnding +
    '  end;' + LineEnding +
    '  generic TChild<T> = class(TBase)' + LineEnding +
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('generic-inherited-unexpected-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
...
procedure CheckInstalledSourceFunctionResultAmbiguousOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  HelperBPath := ProjectRoot + DirectorySeparator + 'helperb.pas';
  RootSourceText :=
    'program InstalledImportedFunctionResultAmbiguousOverloadCalls;' +
    LineEnding +
    'uses HelperA, HelperB;' + LineEnding +
    'function Count: Integer;' + LineEnding +
    'begin' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedFunctionResultAmbiguousOverloadCalls',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-function-result-ambiguous-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-function-result-ambiguous-overload-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-function-result-ambiguous-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-function-result-ambiguous-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedMemberFunctionResultWrongArgumentCountDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedMemberFunctionResultWrongArgumentCountCalls;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'function Flag: Boolean;' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedMemberFunctionResultWrongArgumentCountCalls',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-member-function-result-wrong-argument-count-diagnostic');
    if not SameText(
      Diagnostics.LastDiagnosticCode,
      'sema.wrong-argument-count'
    ) then
      Fail('unexpected-imported-member-function-result-wrong-argument-count-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-member-function-result-wrong-argument-count-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-member-function-result-wrong-argument-count-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-member-function-result-wrong-argument-count-semantic-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-member-function-result-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-member-function-result-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceMemberFunctionResultCallTypeMismatchStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedMemberFunctionResultTypeMismatchCalls;' +
    LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedMemberFunctionResultTypeMismatchCalls',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-member-function-result-type-mismatch-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-member-function-result-type-mismatch-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-member-function-result-type-mismatch-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-member-function-result-type-mismatch-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceMemberFunctionResultWrongArgumentCountStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedMemberFunctionResultWrongArgumentCountCalls;' +
    LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedMemberFunctionResultWrongArgumentCountCalls',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-member-function-result-wrong-argument-count-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-member-function-result-wrong-argument-count-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-member-function-result-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-member-function-result-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedMemberFunctionResultNoMatchingOverloadDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedMemberFunctionResultNoMatchingOverloadCalls;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'function Flag: Boolean;' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedMemberFunctionResultNoMatchingOverloadCalls',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-member-function-result-no-matching-overload-diagnostic');
    if not SameText(
      Diagnostics.LastDiagnosticCode,
      'sema.no-matching-overload'
    ) then
      Fail('unexpected-imported-member-function-result-no-matching-overload-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-member-function-result-no-matching-overload-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-member-function-result-no-matching-overload-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-member-function-result-no-matching-overload-semantic-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-member-function-result-no-matching-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-member-function-result-no-matching-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceMemberFunctionResultNoMatchingOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedMemberFunctionResultNoMatchingOverloadCalls;' +
    LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedMemberFunctionResultNoMatchingOverloadCalls',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-member-function-result-no-matching-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-member-function-result-no-matching-overload-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-member-function-result-no-matching-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-member-function-result-no-matching-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceMemberFunctionResultAmbiguousOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedMemberFunctionResultAmbiguousOverloadCalls;' +
    LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedMemberFunctionResultAmbiguousOverloadCalls',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-member-function-result-ambiguous-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-member-function-result-ambiguous-overload-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-member-function-result-ambiguous-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-member-function-result-ambiguous-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceInheritedMemberFunctionResultWrongArgumentCountStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledImportedInheritedMemberFunctionResultWrongArgumentCountCalls;' + LineEnding +
    'uses Worker;' + LineEnding +
    'var' + LineEnding +
    '  Worker: TWorker;' + LineEnding +
    'function Flag: Boolean;' + LineEnding +
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledImportedInheritedMemberFunctionResultWrongArgumentCountCalls',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-imported-inherited-member-function-result-wrong-argument-count-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-imported-inherited-member-function-result-wrong-argument-count-semantic-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-imported-inherited-member-function-result-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-imported-inherited-member-function-result-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInheritedImplicitSelfBareMethodUnknownMemberDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  SourceText :=
    'program InheritedImplicitSelfBareMethodUnknownMember;' + LineEnding +
    'type' + LineEnding +
    '  TBaseWorker = class' + LineEnding +
    '    procedure Touch;' + LineEnding +
    '  end;' + LineEnding +
  ...
  try
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-inherited-implicit-self-bare-method-unknown-member-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.unknown-member') then
      Fail('unexpected-inherited-implicit-self-bare-method-unknown-member-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-inherited-implicit-self-bare-method-unknown-member-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Missing', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('inherited-implicit-self-bare-method-unknown-member-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-inherited-implicit-self-bare-method-unknown-member-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-inherited-implicit-self-bare-method-unknown-member-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-inherited-implicit-self-bare-method-unknown-member-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyImplicitSelfBareMethodUnknownMemberDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfUnknownMember;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfUnknownMember',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-unknown-member-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.unknown-member') then
      Fail('unexpected-imported-unit-body-implicit-self-unknown-member-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-unknown-member-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Missing', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-unknown-member-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-unknown-member-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-unknown-member-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-unknown-member-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfBareMethodUnknownMemberDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfUnknownMember;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfUnknownMember',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-unknown-member-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.unknown-member') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-unknown-member-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-unknown-member-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Missing', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-unknown-member-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-unknown-member-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-unknown-member-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-unknown-member-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyImplicitSelfKnownFieldInvalidCallShapeDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfKnownFieldInvalidCallShape;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfKnownFieldInvalidCallShape',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-known-field-invalid-call-shape-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.invalid-call-shape') then
      Fail('unexpected-imported-unit-body-implicit-self-known-field-invalid-call-shape-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-known-field-invalid-call-shape-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Value', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-known-field-invalid-call-shape-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-known-field-invalid-call-shape-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-known-field-invalid-call-shape-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-known-field-invalid-call-shape-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyImplicitSelfKnownFieldInvalidCallShapeStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledUnitBodyImplicitSelfKnownFieldInvalidCallShape;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledUnitBodyImplicitSelfKnownFieldInvalidCallShape',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-unit-body-implicit-self-known-field-invalid-call-shape-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-unit-body-implicit-self-known-field-invalid-call-shape-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-unit-body-implicit-self-known-field-invalid-call-shape-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-unit-body-implicit-self-known-field-invalid-call-shape-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyImplicitSelfKnownPropertyInvalidCallShapeDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfKnownPropertyInvalidCallShape;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfKnownPropertyInvalidCallShape',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-known-property-invalid-call-shape-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.invalid-call-shape') then
      Fail('unexpected-imported-unit-body-implicit-self-known-property-invalid-call-shape-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-known-property-invalid-call-shape-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Value', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-known-property-invalid-call-shape-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-known-property-invalid-call-shape-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-known-property-invalid-call-shape-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-known-property-invalid-call-shape-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyImplicitSelfKnownPropertyInvalidCallShapeStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledUnitBodyImplicitSelfKnownPropertyInvalidCallShape;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledUnitBodyImplicitSelfKnownPropertyInvalidCallShape',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-unit-body-implicit-self-known-property-invalid-call-shape-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-unit-body-implicit-self-known-property-invalid-call-shape-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-unit-body-implicit-self-known-property-invalid-call-shape-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-unit-body-implicit-self-known-property-invalid-call-shape-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyInheritedImplicitSelfKnownFieldInvalidCallShapeStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledUnitBodyInheritedImplicitSelfKnownFieldInvalidCallShape;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledUnitBodyInheritedImplicitSelfKnownFieldInvalidCallShape',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-unit-body-inherited-implicit-self-known-field-invalid-call-shape-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-unit-body-inherited-implicit-self-known-field-invalid-call-shape-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-unit-body-inherited-implicit-self-known-field-invalid-call-shape-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-unit-body-inherited-implicit-self-known-field-invalid-call-shape-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfKnownPropertyInvalidCallShapeDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfKnownPropertyInvalidCallShape;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfKnownPropertyInvalidCallShape',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-known-property-invalid-call-shape-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.invalid-call-shape') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-known-property-invalid-call-shape-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-known-property-invalid-call-shape-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Value', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-known-property-invalid-call-shape-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-known-property-invalid-call-shape-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-known-property-invalid-call-shape-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-known-property-invalid-call-shape-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfWrongArgumentCount;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfWrongArgumentCount',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-wrong-argument-count-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.wrong-argument-count') then
      Fail('unexpected-imported-unit-body-implicit-self-wrong-argument-count-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-wrong-argument-count-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-wrong-argument-count-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-wrong-argument-count-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfBareMethodWrongArgumentCountDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfWrongArgumentCount;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfWrongArgumentCount',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-wrong-argument-count-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.wrong-argument-count') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-wrong-argument-count-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-wrong-argument-count-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Touch', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-wrong-argument-count-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-wrong-argument-count-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfBareMethodTypeMismatchDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfTypeMismatch;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfTypeMismatch',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-type-mismatch-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.type-mismatch') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-type-mismatch-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-type-mismatch-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Touch', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-type-mismatch-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-type-mismatch-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-type-mismatch-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-type-mismatch-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfBareMethodFunctionResultTypeMismatchDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfFunctionResultTypeMismatch;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfFunctionResultTypeMismatch',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-function-result-type-mismatch-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.type-mismatch') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-type-mismatch-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-type-mismatch-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Touch', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-function-result-type-mismatch-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-function-result-type-mismatch-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-type-mismatch-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-type-mismatch-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfBareMethodNoMatchingOverloadDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfNoMatchingOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfNoMatchingOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-no-matching-overload-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.no-matching-overload') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-no-matching-overload-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-no-matching-overload-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Touch', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-no-matching-overload-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-no-matching-overload-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-no-matching-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-no-matching-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfBareMethodFunctionResultWrongArgumentCountDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfFunctionResultWrongArgumentCount;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfFunctionResultWrongArgumentCount',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-function-result-wrong-argument-count-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.wrong-argument-count') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-wrong-argument-count-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-wrong-argument-count-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Touch', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-function-result-wrong-argument-count-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-function-result-wrong-argument-count-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfBareMethodFunctionResultNoMatchingOverloadDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfFunctionResultNoMatchingOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfFunctionResultNoMatchingOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-function-result-no-matching-overload-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.no-matching-overload') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-no-matching-overload-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-no-matching-overload-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Touch', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-function-result-no-matching-overload-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-function-result-no-matching-overload-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-no-matching-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-no-matching-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyInheritedImplicitSelfBareMethodFunctionResultAmbiguousOverloadDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyInheritedImplicitSelfFunctionResultAmbiguousOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyInheritedImplicitSelfFunctionResultAmbiguousOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-inherited-implicit-self-function-result-ambiguous-overload-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.ambiguous-overload') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-ambiguous-overload-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-ambiguous-overload-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Touch', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-inherited-implicit-self-function-result-ambiguous-overload-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-inherited-implicit-self-function-result-ambiguous-overload-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-ambiguous-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-inherited-implicit-self-function-result-ambiguous-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfTypeMismatch;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfTypeMismatch',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-type-mismatch-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.type-mismatch') then
      Fail('unexpected-imported-unit-body-implicit-self-type-mismatch-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-type-mismatch-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-type-mismatch-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-type-mismatch-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-type-mismatch-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-type-mismatch-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyImplicitSelfBareMethodNoMatchingOverloadDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfNoMatchingOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfNoMatchingOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-no-matching-overload-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.no-matching-overload') then
      Fail('unexpected-imported-unit-body-implicit-self-no-matching-overload-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-no-matching-overload-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-no-matching-overload-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-no-matching-overload-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-no-matching-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-no-matching-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyImplicitSelfBareMethodFunctionResultTypeMismatchDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfFunctionResultTypeMismatch;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfFunctionResultTypeMismatch',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-function-result-type-mismatch-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.type-mismatch') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-type-mismatch-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-type-mismatch-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-function-result-type-mismatch-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-function-result-type-mismatch-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-type-mismatch-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-type-mismatch-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyImplicitSelfBareMethodFunctionResultWrongArgumentCountDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfFunctionResultWrongArgumentCount;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfFunctionResultWrongArgumentCount',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-function-result-wrong-argument-count-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.wrong-argument-count') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-wrong-argument-count-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-wrong-argument-count-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-function-result-wrong-argument-count-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-function-result-wrong-argument-count-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyImplicitSelfBareMethodFunctionResultNoMatchingOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyImplicitSelfFunctionResultNoMatchingOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyImplicitSelfFunctionResultNoMatchingOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-implicit-self-function-result-no-matching-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-implicit-self-function-result-no-matching-overload-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-implicit-self-function-result-no-matching-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-implicit-self-function-result-no-matching-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyImplicitSelfBareMethodFunctionResultAmbiguousOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyImplicitSelfFunctionResultAmbiguousOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyImplicitSelfFunctionResultAmbiguousOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-implicit-self-function-result-ambiguous-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-implicit-self-function-result-ambiguous-overload-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-implicit-self-function-result-ambiguous-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-implicit-self-function-result-ambiguous-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyImplicitSelfBareMethodAmbiguousOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyImplicitSelfAmbiguousOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyImplicitSelfAmbiguousOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-implicit-self-ambiguous-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-implicit-self-ambiguous-overload-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-implicit-self-ambiguous-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-implicit-self-ambiguous-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyImplicitSelfBareMethodNoMatchingOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyImplicitSelfNoMatchingOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyImplicitSelfNoMatchingOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-implicit-self-no-matching-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-implicit-self-no-matching-overload-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-implicit-self-no-matching-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-implicit-self-no-matching-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyImplicitSelfBareMethodTypeMismatchStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyImplicitSelfTypeMismatch;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyImplicitSelfTypeMismatch',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-implicit-self-type-mismatch-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-implicit-self-type-mismatch-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-implicit-self-type-mismatch-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-implicit-self-type-mismatch-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyImplicitSelfBareMethodWrongArgumentCountStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyImplicitSelfWrongArgumentCount;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyImplicitSelfWrongArgumentCount',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-implicit-self-wrong-argument-count-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-implicit-self-wrong-argument-count-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-implicit-self-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-implicit-self-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyInheritedImplicitSelfBareMethodWrongArgumentCountStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyInheritedImplicitSelfWrongArgumentCount;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyInheritedImplicitSelfWrongArgumentCount',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-wrong-argument-count-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-inherited-implicit-self-wrong-argument-count-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-wrong-argument-count-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-wrong-argument-count-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyInheritedImplicitSelfBareMethodTypeMismatchStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyInheritedImplicitSelfTypeMismatch;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyInheritedImplicitSelfTypeMismatch',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-type-mismatch-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-inherited-implicit-self-type-mismatch-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-type-mismatch-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-type-mismatch-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyInheritedImplicitSelfBareMethodNoMatchingOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyInheritedImplicitSelfNoMatchingOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyInheritedImplicitSelfNoMatchingOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-no-matching-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-inherited-implicit-self-no-matching-overload-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-no-matching-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-no-matching-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckInstalledSourceUnitBodyInheritedImplicitSelfBareMethodAmbiguousOverloadStaysDeferred;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program InstalledSourceUnitBodyInheritedImplicitSelfAmbiguousOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'InstalledSourceUnitBodyInheritedImplicitSelfAmbiguousOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if Diagnostics.HasErrors then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-ambiguous-overload-diagnostic:' +
        Diagnostics.LastDiagnosticCode);
    if Model = nil then
      Fail('missing-installed-source-unit-body-inherited-implicit-self-ambiguous-overload-model');
    if not SameText(Model.Status, 'ready') then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-ambiguous-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-installed-source-unit-body-inherited-implicit-self-ambiguous-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
procedure CheckImportedUnitBodyImplicitSelfBareMethodFunctionResultAmbiguousOverloadDiagnostic;
var
  Analyzer: TSemanticAnalyzer;
  Ast: TAstFacade;
  Diagnostics: TDiagnosticsSink;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfFunctionResultAmbiguousOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfFunctionResultAmbiguousOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-function-result-ambiguous-overload-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.ambiguous-overload') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-ambiguous-overload-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-ambiguous-overload-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-function-result-ambiguous-overload-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-function-result-ambiguous-overload-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-ambiguous-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-function-result-ambiguous-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
begin
  ...
  UnitPath := ProjectRoot + DirectorySeparator + 'worker.pas';
  RootSourceText :=
    'program ImportedUnitBodyImplicitSelfAmbiguousOverload;' + LineEnding +
    'uses Worker;' + LineEnding +
    'begin' + LineEnding +
    'end.' + LineEnding;
  WriteTextFile(
  ...
  try
    ...
    UnitGraph.AddResolvedUnit(
      BuildResolvedUnit(
        'ImportedUnitBodyImplicitSelfAmbiguousOverload',
        '',
        ruoRootSource,
        '',
        'program',
    ...
    Model := Analyzer.DetachModel;
    if not Diagnostics.HasErrors then
      Fail('missing-imported-unit-body-implicit-self-ambiguous-overload-diagnostic');
    if not SameText(Diagnostics.LastDiagnosticCode, 'sema.ambiguous-overload') then
      Fail('unexpected-imported-unit-body-implicit-self-ambiguous-overload-diagnostic-code:' +
        Diagnostics.LastDiagnosticCode);
    if not SameText(Diagnostics.LastDiagnosticPhase, 'sema') then
      Fail('unexpected-imported-unit-body-implicit-self-ambiguous-overload-diagnostic-phase:' +
        Diagnostics.LastDiagnosticPhase);
    if Pos('Pick', Diagnostics.LastDiagnosticMessage) <= 0 then
      Fail('imported-unit-body-implicit-self-ambiguous-overload-diagnostic-missing-name');
    if Model = nil then
      Fail('missing-imported-unit-body-implicit-self-ambiguous-overload-model');
    if not SameText(Model.Status, 'failure') then
      Fail('unexpected-imported-unit-body-implicit-self-ambiguous-overload-model-status:' +
        Model.Status);
    if Model.BindingCount <> 0 then
      Fail('unexpected-imported-unit-body-implicit-self-ambiguous-overload-binding-count:' +
        IntToStr(Model.BindingCount));
  finally
    Model.Free;
    Analyzer.Free;
...
begin
  ...
  try
    ...
    CheckImportedKnownFieldMemberCallDiagnostic;
    CheckImportedInheritedKnownFieldMemberCallDiagnostic;
    CheckInstalledSourceKnownFieldMemberCallStaysDeferred;
    CheckInstalledSourceInheritedKnownFieldMemberCallStaysDeferred;
    CheckKnownPropertyMemberCallDiagnostic;
    CheckImportedKnownPropertyMemberCallDiagnostic;
    CheckImportedInheritedKnownPropertyMemberCallDiagnostic;
    CheckInstalledSourceKnownPropertyMemberCallStaysDeferred;
    CheckInstalledSourceInheritedKnownPropertyMemberCallStaysDeferred;
    ...
    CheckInstalledSourceFunctionResultAmbiguousOverloadStaysDeferred;
    ...
    CheckInstalledSourceMemberFunctionResultCallTypeMismatchStaysDeferred;
    CheckImportedMemberFunctionResultWrongArgumentCountDiagnostic;
    CheckInstalledSourceMemberFunctionResultWrongArgumentCountStaysDeferred;
    ...
    CheckInstalledSourceInheritedMemberFunctionResultWrongArgumentCountStaysDeferred;
    ...
    CheckInheritedImplicitSelfBareMethodUnknownMemberDiagnostic;
    ...
    CheckInstalledSourceUnitBodyImplicitSelfKnownFieldInvalidCallShapeStaysDeferred;
    CheckImportedUnitBodyImplicitSelfKnownPropertyInvalidCallShapeDiagnostic;
    CheckInstalledSourceUnitBodyImplicitSelfKnownPropertyInvalidCallShapeStaysDeferred;
    ...
    CheckImportedUnitBodyInheritedImplicitSelfBareMethodFunctionResultTypeMismatchDiagnostic;
    CheckImportedUnitBodyInheritedImplicitSelfBareMethodFunctionResultWrongArgumentCountDiagnostic;
    ...
    CheckImportedUnitBodyInheritedImplicitSelfBareMethodFunctionResultAmbiguousOverloadDiagnostic;
    ...
    CheckDelphiStyleGenericMemberCallBinding;
    CheckGenericTypeMismatchDiagnostic;
    CheckGenericMultiParamBinding;
    CheckGenericMultiParamTypeMismatch;
