...
BUILD_DIR="$REPO_ROOT/build/.tmp/compiler-incremental-cache-entry-identity"
SOURCE_PATH="$SCRIPT_DIR/test_incremental_cache_entry_identity.pas"
BINARY_PATH="$BUILD_DIR/test_incremental_cache_entry_identity"
...
printf 'incremental-cache-entry-identity-build=pass\n'
