...
2. `docs/worktrees.md`
3. `core/AGENTS.md`
4. `core/docs/design-conventions.md`
5. `docs/adr/0001-fpc-reference-baseline.md`
6. `docs/architecture/documentation-baseline-specification.md`
...
- `nextpas.core` AI/协作入口：`core/AGENTS.md`
