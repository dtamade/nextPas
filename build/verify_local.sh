...
require_output_pattern '^package-install-plan-status=deferred$' "$STAGE0_DOCTOR_OUTPUT" 'missing-stage0-doctor-package-install-plan-status'
...
require_output_pattern '^command-envelope=.*"packageWorkflowStatus":"missing".*"packageManifestStatus":"missing".*"packageInstallPlanStatus":"deferred".*"packageSourceRootCount":0' "$STAGE0_DOCTOR_OUTPUT" 'missing-stage0-doctor-envelope-package'
...
require_output_pattern '^package-install-plan-status=deferred$' "$STAGE0_DOCTOR_PACKAGE_WORKSPACE_OUTPUT" 'missing-stage0-doctor-package-workspace-install-plan-status'
...
require_output_pattern '^command-envelope=.*"packageWorkflowStatus":"ready".*"packageManifestStatus":"ready".*"packageInstallPlanStatus":"deferred".*"packageSourceRootCount":1' "$STAGE0_DOCTOR_PACKAGE_WORKSPACE_OUTPUT" 'missing-stage0-doctor-package-workspace-envelope-package'
...
require_output_pattern '^package-install-plan-status=deferred$' "$STAGE0_DOCTOR_WORKSPACE_MEMBER_OUTPUT" 'missing-stage0-doctor-workspace-member-install-plan-status'
...
require_output_pattern '^command-envelope=.*"packageWorkflowStatus":"ready".*"packageManifestStatus":"ready".*"packageInstallPlanStatus":"deferred".*"packageSourceRootCount":1' "$STAGE0_DOCTOR_WORKSPACE_MEMBER_OUTPUT" 'missing-stage0-doctor-workspace-member-envelope-package'
...
require_output_pattern '^package-install-plan-status=deferred$' "$STAGE0_PKG_WORKSPACE_MEMBER_OUTPUT" 'missing-stage0-pkg-workspace-member-install-plan-status'
