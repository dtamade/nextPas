...
- [ ] #5 Gate 3 process lifecycle (3天) — 解锁后续 Gates
- [ ] #7 Platform Phase 1: DynLibs→platform.dl (2天)

### Sprint 2 (第 2 周)
- [ ] #7 Platform Phase 2-4: Socket/Windows/Unix (3.5天)
- [ ] #3 TThread: 创建 TWorkerThread (3天)

### Sprint 3 (第 3 周)
- [ ] #2 transport.pas 平台单元替换 (1天)
